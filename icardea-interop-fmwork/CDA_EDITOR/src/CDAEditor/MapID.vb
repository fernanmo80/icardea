...
Public Class MapID
    ...
    Private Sub mapButton_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mapButton.Click
        ...
        Try
            ...
            Dim returndata As String = RunClient(System.Configuration.ConfigurationSettings.AppSettings("PIX_ip").ToString(), System.Configuration.ConfigurationSettings.AppSettings("PIX_ip").ToString(), CInt(System.Configuration.ConfigurationSettings.AppSettings("PIX_port")), msg)
            If returndata.Trim.Length = 0 Then
                Return
            End If
