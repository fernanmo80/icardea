...
Public Class MainForm
    ...
    Private Sub GetLab(ByVal xd As XmlDocument)
        ...
        Try
            ...
            End If
            For i As Integer = 0 To nodelist.Count - 1
                If nodelist(i).SelectNodes("templateId[@root='1.3.6.1.4.1.19376.1.5.3.1.4.13']").Count > 0 And nodelist(i).SelectNodes("templateId[@root='1.3.6.1.4.1.19376.1.5.3.1.4.13.2']").Count = 0 Then
    ...
    Private Sub GetVital(ByVal xd As XmlDocument)
        ...
        Try
            ...
            End If
            For i As Integer = 0 To nodelist.Count - 1
                If nodelist(i).SelectNodes("templateId[@root='1.3.6.1.4.1.19376.1.5.3.1.4.13.2']").Count > 0 Then
    ...
    Private Sub GetMed(ByVal xd As XmlDocument)
        ...
        Try
            ...
            End If
            For i As Integer = 0 To nodelist.Count - 1
                If nodelist(i).SelectNodes("templateId[@root='1.3.6.1.4.1.19376.1.5.3.1.4.7.1']").Count > 0 Then
    ...
    Private Sub importButton_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles importButton.Click
        If CreateCDA(EDFTextBox.Text.Trim) = False Then
    ...
    Private Function CreateCDA(ByVal new_file As String) As Boolean
        Dim filestr As String = ""
