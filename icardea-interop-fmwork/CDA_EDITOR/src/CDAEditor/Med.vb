    ...
    Public Sub New(ByVal dr As DataRow)
        ...
        If Not IsNothing(dr) Then
            ...
            Catch ex As Exception
                ...
                MessageBox.Show("THE MEDICATION CODE WAS NOT FOUND...YOU HAVE TO SELECT THE MEDICATION FROM THE LIST!!!", "MEDICATION CODE MISSING", MessageBoxButtons.OK, MessageBoxIcon.Warning, MessageBoxDefaultButton.Button1)
