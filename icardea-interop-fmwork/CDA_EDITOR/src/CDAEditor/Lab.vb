    ...
    Public Sub New(ByVal dr As DataRow)
        ...
        If Not IsNothing(dr) Then
            Try
                ...
                End Try
            Catch ex As Exception
                MessageBox.Show("THE LAB EXAM CODE WAS NOT FOUND...YOU HAVE TO SELECT THE LAB EXAM FROM THE LIST!!!", "LAB EXAM CODE MISSING", MessageBoxButtons.OK, MessageBoxIcon.Warning, MessageBoxDefaultButton.Button1)
