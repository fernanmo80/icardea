...
<script LANGUAGE="JavaScript" >
	function SetUpdateData(protocol_id,his_id,implant_id,lastname,firstname,birthdate,sex,address,city,state,postal){
			document.getElementById('protocol_id').value=protocol_id;
			document.getElementById('his_id1').value=his_id;
			document.getElementById('implant_id').value=implant_id;
			...
			<fieldset>
				...
				<table class="main22_0">
					...
					<tr>
						...
						{
						?>
						<td class="main22_2"><label type="text" size="20" class="text"><?php echo $_POST['auth_name'];?></label></td>
						<?php
						}
						if ($_POST['lastname']!='')
						{
				...
				<INPUT type="hidden" id="update" name="update"/>
					...
					if(isset($_POST['msg'])){
						...
						if($err_seg=='' && $msa_res=='AA' && $qak_res=='OK'){
							...
							$page_res=10;
							$protocol_id=$his_id=$implant_id=$lastname=$firstname=$dob=$sex=$address=$city=$state=$postal="";
