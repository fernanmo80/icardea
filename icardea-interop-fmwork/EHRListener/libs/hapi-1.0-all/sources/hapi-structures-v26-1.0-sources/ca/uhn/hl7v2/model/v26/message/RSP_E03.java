...
/**
 * <p>Represents a RSP_E03 message structure (see chapter 16.3.4). This structure contains the 
 ...
 * 7: RSP_E03_INVOICE_PROCESSING_RESULTS_INFO (a Group object) <b>optional repeating</b><br>
 */
public class RSP_E03 extends AbstractMessage  {

	/** 
	 * Creates a new RSP_E03 Group with custom ModelClassFactory.
	 */
	public RSP_E03(ModelClassFactory factory) {
	   super(factory);
	   init(factory);
	}
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      this.add(RSP_E03_INVOICE_PROCESSING_RESULTS_INFO.class, false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating RSP_E03 - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public RSP_E03_INVOICE_PROCESSING_RESULTS_INFO getINVOICE_PROCESSING_RESULTS_INFO() { 
	   ...
	   try {
	      ret = (RSP_E03_INVOICE_PROCESSING_RESULTS_INFO)this.get("INVOICE_PROCESSING_RESULTS_INFO");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public RSP_E03_INVOICE_PROCESSING_RESULTS_INFO getINVOICE_PROCESSING_RESULTS_INFO(int rep) throws HL7Exception { 
	   return (RSP_E03_INVOICE_PROCESSING_RESULTS_INFO)this.get("INVOICE_PROCESSING_RESULTS_INFO", rep);
	}
	...
	/**
	 * Inserts a specific repetition of RSP_E03_INVOICE_PROCESSING_RESULTS_INFO
	 * (a Group object)
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	public void  insertINVOICE_PROCESSING_RESULTS_INFO(RSP_E03_INVOICE_PROCESSING_RESULTS_INFO structure, int rep) throws HL7Exception { 
	   super.insertRepetition( structure, rep);
	}
	 ...
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	public RSP_E03_INVOICE_PROCESSING_RESULTS_INFO insertINVOICE_PROCESSING_RESULTS_INFO(int rep) throws HL7Exception { 
	   return (RSP_E03_INVOICE_PROCESSING_RESULTS_INFO)super.insertRepetition("INVOICE_PROCESSING_RESULTS_INFO", rep);
	}

	/**
	 * Removes a specific repetition of RSP_E03_INVOICE_PROCESSING_RESULTS_INFO
	 * (a Group object)
	 * @see AbstractGroup#insertremoveRepetition(String, int) 
	 */
	public RSP_E03_INVOICE_PROCESSING_RESULTS_INFO removeINVOICE_PROCESSING_RESULTS_INFO(int rep) throws HL7Exception { 
	   return (RSP_E03_INVOICE_PROCESSING_RESULTS_INFO)super.removeRepetition("INVOICE_PROCESSING_RESULTS_INFO", rep);
	}
