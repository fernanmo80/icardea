...
public class RDS_O13_ORDER_DETAIL extends AbstractGroup {
	...
	public RDS_O13_ORDER_DETAIL(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      this.add(RDS_O13_ORDER_DETAIL_SUPPLEMENT.class, false, false);
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating RDS_O13_ORDER_DETAIL - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public RDS_O13_ORDER_DETAIL_SUPPLEMENT getORDER_DETAIL_SUPPLEMENT() { 
	   ...
	   try {
	      ret = (RDS_O13_ORDER_DETAIL_SUPPLEMENT)this.get("ORDER_DETAIL_SUPPLEMENT");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
