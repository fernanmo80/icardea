 ...
 * 4: CTD (Contact Data) <b>repeating</b><br>
 * 5: LOC (Location Identification) <b>optional repeating</b><br>
 * 6: ROL (Role) <b>optional repeating</b><br>
 * 7: EHC_E20_PAT_INFO (a Group object) <b>repeating</b><br>
 * 8: EHC_E20_PSL_ITEM_INFO (a Group object) <b>repeating</b><br>
 */
public class EHC_E20 extends AbstractMessage  {

	/** 
	 * Creates a new EHC_E20 Group with custom ModelClassFactory.
	 */
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating EHC_E20 - this is probably a bug in the source code generator.", e);
	   }
	}
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public EHC_E20_PAT_INFO getPAT_INFO(int rep) throws HL7Exception { 
	   return (EHC_E20_PAT_INFO)this.get("PAT_INFO", rep);
	}
	...
	/**
	 * Inserts a specific repetition of EHC_E20_PAT_INFO
	 * (a Group object)
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	...
	/**
	 * Removes a specific repetition of EHC_E20_PAT_INFO
	 * (a Group object)
	 * @see AbstractGroup#insertremoveRepetition(String, int) 
	 */
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public EHC_E20_PSL_ITEM_INFO getPSL_ITEM_INFO(int rep) throws HL7Exception { 
	   return (EHC_E20_PSL_ITEM_INFO)this.get("PSL_ITEM_INFO", rep);
	}
	...
	/**
	 * Inserts a specific repetition of EHC_E20_PSL_ITEM_INFO
	 * (a Group object)
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	...
	/**
	 * Removes a specific repetition of EHC_E20_PSL_ITEM_INFO
	 * (a Group object)
	 * @see AbstractGroup#insertremoveRepetition(String, int) 
	 */
