...
public class PPV_PCA_ORDER extends AbstractGroup {
	...
	public PPV_PCA_ORDER(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      this.add(PPV_PCA_ORDER_DETAIL.class, false, false);
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating PPV_PCA_ORDER - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public PPV_PCA_ORDER_DETAIL getORDER_DETAIL() { 
	   ...
	   try {
	      ret = (PPV_PCA_ORDER_DETAIL)this.get("ORDER_DETAIL");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
