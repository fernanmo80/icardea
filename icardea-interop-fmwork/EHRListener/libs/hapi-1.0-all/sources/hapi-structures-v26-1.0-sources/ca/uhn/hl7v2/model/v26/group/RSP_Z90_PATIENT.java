...
public class RSP_Z90_PATIENT extends AbstractGroup {
	...
	public RSP_Z90_PATIENT(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      this.add(RSP_Z90_VISIT.class, false, false);
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating RSP_Z90_PATIENT - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public RSP_Z90_VISIT getVISIT() { 
	   ...
	   try {
	      ret = (RSP_Z90_VISIT)this.get("VISIT");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
