 ...
 * 4: OMP_O09_PATIENT (a Group object) <b>optional </b><br>
 * 5: OMP_O09_ORDER (a Group object) <b>repeating</b><br>
 */
public class OMP_O09 extends AbstractMessage  {
	...
	public OMP_O09_PATIENT getPATIENT() { 
	   ...
	   try {
	      ret = (OMP_O09_PATIENT)this.get("PATIENT");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	...
	public OMP_O09_ORDER getORDER() { 
	   ...
	   try {
	      ret = (OMP_O09_ORDER)this.get("ORDER");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public OMP_O09_ORDER getORDER(int rep) throws HL7Exception { 
	   return (OMP_O09_ORDER)this.get("ORDER", rep);
	}
	...
	/**
	 * Inserts a specific repetition of OMP_O09_ORDER
	 * (a Group object)
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	...
	/**
	 * Removes a specific repetition of OMP_O09_ORDER
	 * (a Group object)
	 * @see AbstractGroup#insertremoveRepetition(String, int) 
	 */
