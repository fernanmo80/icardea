...
/**
 * <p>Represents a QBP_E22 message structure (see chapter 16.3.12). This structure contains the 
 * following elements: </p>
 * 0: MSH (Message Header) <b></b><br>
 * 1: SFT (Software Segment) <b>optional repeating</b><br>
 * 2: UAC (User Authentication Credential Segment) <b>optional repeating</b><br>
 * 3: QPD (Query Parameter Definition) <b></b><br>
 * 4: RCP (Response Control Parameter) <b></b><br>
 */
public class QBP_E22 extends AbstractMessage  {

	/** 
	 * Creates a new QBP_E22 Group with custom ModelClassFactory.
	 */
	public QBP_E22(ModelClassFactory factory) {
	   super(factory);
	   init(factory);
	}
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating QBP_E22 - this is probably a bug in the source code generator.", e);
	   }
	}
