...
public class ORM_O01_PATIENT extends AbstractGroup {
	...
	public ORM_O01_PATIENT(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      this.add(ORM_O01_PATIENT_VISIT.class, false, false);
	      this.add(ORM_O01_INSURANCE.class, false, true);
	      this.add(GT1.class, false, false);
	      this.add(AL1.class, false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating ORM_O01_PATIENT - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public ORM_O01_PATIENT_VISIT getPATIENT_VISIT() { 
	   ...
	   try {
	      ret = (ORM_O01_PATIENT_VISIT)this.get("PATIENT_VISIT");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	...
	public ORM_O01_INSURANCE getINSURANCE() { 
	   ...
	   try {
	      ret = (ORM_O01_INSURANCE)this.get("INSURANCE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public ORM_O01_INSURANCE getINSURANCE(int rep) throws HL7Exception { 
	   return (ORM_O01_INSURANCE)this.get("INSURANCE", rep);
	}
	...
	/**
	 * Inserts a specific repetition of ORM_O01_INSURANCE
	 * (a Group object)
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	...
	/**
	 * Removes a specific repetition of ORM_O01_INSURANCE
	 * (a Group object)
	 * @see AbstractGroup#insertremoveRepetition(String, int) 
	 */
