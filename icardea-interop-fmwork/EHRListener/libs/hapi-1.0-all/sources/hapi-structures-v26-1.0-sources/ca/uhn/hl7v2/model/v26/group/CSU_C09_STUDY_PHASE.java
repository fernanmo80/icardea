...
public class CSU_C09_STUDY_PHASE extends AbstractGroup {
	...
	public CSU_C09_STUDY_PHASE(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      this.add(CSU_C09_STUDY_SCHEDULE.class, true, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating CSU_C09_STUDY_PHASE - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public CSU_C09_STUDY_SCHEDULE getSTUDY_SCHEDULE() { 
	   ...
	   try {
	      ret = (CSU_C09_STUDY_SCHEDULE)this.get("STUDY_SCHEDULE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 */
	public CSU_C09_STUDY_SCHEDULE getSTUDY_SCHEDULE(int rep) throws HL7Exception { 
	   return (CSU_C09_STUDY_SCHEDULE)this.get("STUDY_SCHEDULE", rep);
	}
	...
	/**
	 * Inserts a specific repetition of CSU_C09_STUDY_SCHEDULE
	 * (a Group object)
	...
	/**
	 * Removes a specific repetition of CSU_C09_STUDY_SCHEDULE
	 * (a Group object)
