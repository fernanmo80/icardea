...
public class OSR_Q06_ORDER extends AbstractGroup {
	...
	public OSR_Q06_ORDER(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      this.add(OSR_Q06_TIMING.class, false, true);
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating OSR_Q06_ORDER - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public OSR_Q06_TIMING getTIMING() { 
	   ...
	   try {
	      ret = (OSR_Q06_TIMING)this.get("TIMING");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 */
	public OSR_Q06_TIMING getTIMING(int rep) throws HL7Exception { 
	   return (OSR_Q06_TIMING)this.get("TIMING", rep);
	}
	...
	/**
	 * Inserts a specific repetition of OSR_Q06_TIMING
	 * (a Group object)
	...
	/**
	 * Removes a specific repetition of OSR_Q06_TIMING
	 * (a Group object)
