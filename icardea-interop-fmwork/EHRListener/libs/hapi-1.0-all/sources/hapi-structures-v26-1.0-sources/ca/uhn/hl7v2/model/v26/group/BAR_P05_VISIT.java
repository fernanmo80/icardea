...
public class BAR_P05_VISIT extends AbstractGroup {
	...
	/**
	 * Inserts a specific repetition of BAR_P05_PROCEDURE
	 * (a Group object)
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	...
	/**
	 * Removes a specific repetition of BAR_P05_PROCEDURE
	 * (a Group object)
	 * @see AbstractGroup#insertremoveRepetition(String, int) 
	 */
	...
	/**
	 * Inserts a specific repetition of BAR_P05_INSURANCE
	 * (a Group object)
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	...
	/**
	 * Removes a specific repetition of BAR_P05_INSURANCE
	 * (a Group object)
	 * @see AbstractGroup#insertremoveRepetition(String, int) 
	 */
	...
	/**
	 * Inserts a specific repetition of BLC
	 * (Blood Code)
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	...
	/**
	 * Removes a specific repetition of BLC
	 * (Blood Code)
	 * @see AbstractGroup#insertremoveRepetition(String, int) 
	 */
