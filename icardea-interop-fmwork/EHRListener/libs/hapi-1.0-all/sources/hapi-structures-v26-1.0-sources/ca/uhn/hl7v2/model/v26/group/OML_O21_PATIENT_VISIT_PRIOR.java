...
public class OML_O21_PATIENT_VISIT_PRIOR extends AbstractGroup {
	...
	public OML_O21_PATIENT_VISIT_PRIOR(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating OML_O21_PATIENT_VISIT_PRIOR - this is probably a bug in the source code generator.", e);
	   }
	}
