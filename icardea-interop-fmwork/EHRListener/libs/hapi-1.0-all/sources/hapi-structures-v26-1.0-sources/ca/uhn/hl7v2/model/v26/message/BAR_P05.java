 ...
 * 7: BAR_P05_VISIT (a Group object) <b>repeating</b><br>
 */
public class BAR_P05 extends AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating BAR_P05 - this is probably a bug in the source code generator.", e);
	   }
	}
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public BAR_P05_VISIT getVISIT(int rep) throws HL7Exception { 
	   return (BAR_P05_VISIT)this.get("VISIT", rep);
	}
	...
	/**
	 * Inserts a specific repetition of BAR_P05_VISIT
	 * (a Group object)
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	...
	/**
	 * Removes a specific repetition of BAR_P05_VISIT
	 * (a Group object)
	 * @see AbstractGroup#insertremoveRepetition(String, int) 
	 */
