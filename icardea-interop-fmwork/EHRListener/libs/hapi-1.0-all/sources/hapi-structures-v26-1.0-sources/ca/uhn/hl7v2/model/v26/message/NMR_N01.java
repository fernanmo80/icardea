 ...
 * 5: QRD (Original-Style Query Definition) <b>optional </b><br>
 * 6: NMR_N01_CLOCK_AND_STATS_WITH_NOTES_ALT (a Group object) <b>repeating</b><br>
 */
public class NMR_N01 extends AbstractMessage  {
	...
	/**
	 * Inserts a specific repetition of NMR_N01_CLOCK_AND_STATS_WITH_NOTES_ALT
	 * (a Group object)
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	...
	/**
	 * Removes a specific repetition of NMR_N01_CLOCK_AND_STATS_WITH_NOTES_ALT
	 * (a Group object)
	 * @see AbstractGroup#insertremoveRepetition(String, int) 
	 */
