 ...
 * 3: CSU_C09_PATIENT (a Group object) <b>repeating</b><br>
 */
public class CSU_C09 extends AbstractMessage  {
	...
	public CSU_C09_PATIENT getPATIENT() { 
	   ...
	   try {
	      ret = (CSU_C09_PATIENT)this.get("PATIENT");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public CSU_C09_PATIENT getPATIENT(int rep) throws HL7Exception { 
	   return (CSU_C09_PATIENT)this.get("PATIENT", rep);
	}
	...
	/**
	 * Inserts a specific repetition of CSU_C09_PATIENT
	 * (a Group object)
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	...
	/**
	 * Removes a specific repetition of CSU_C09_PATIENT
	 * (a Group object)
	 * @see AbstractGroup#insertremoveRepetition(String, int) 
	 */
