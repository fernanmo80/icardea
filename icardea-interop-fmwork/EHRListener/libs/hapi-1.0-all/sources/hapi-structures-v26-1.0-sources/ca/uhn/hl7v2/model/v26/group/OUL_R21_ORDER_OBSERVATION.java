...
public class OUL_R21_ORDER_OBSERVATION extends AbstractGroup {
	...
	public OUL_R21_ORDER_OBSERVATION(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      this.add(OUL_R21_TIMING_QTY.class, false, true);
	...
	public OUL_R21_TIMING_QTY getTIMING_QTY() { 
	   ...
	   try {
	      ret = (OUL_R21_TIMING_QTY)this.get("TIMING_QTY");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public OUL_R21_TIMING_QTY getTIMING_QTY(int rep) throws HL7Exception { 
	   return (OUL_R21_TIMING_QTY)this.get("TIMING_QTY", rep);
	}
	...
	/**
	 * Inserts a specific repetition of OUL_R21_TIMING_QTY
	 * (a Group object)
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	...
	/**
	 * Removes a specific repetition of OUL_R21_TIMING_QTY
	 * (a Group object)
	 * @see AbstractGroup#insertremoveRepetition(String, int) 
	 */
	...
	/**
	 * Inserts a specific repetition of OUL_R21_OBSERVATION
	 * (a Group object)
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	...
	/**
	 * Removes a specific repetition of OUL_R21_OBSERVATION
	 * (a Group object)
	 * @see AbstractGroup#insertremoveRepetition(String, int) 
	 */
