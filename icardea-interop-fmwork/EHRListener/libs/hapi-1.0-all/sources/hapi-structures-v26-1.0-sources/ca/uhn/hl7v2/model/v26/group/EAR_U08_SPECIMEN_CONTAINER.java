...
public class EAR_U08_SPECIMEN_CONTAINER extends AbstractGroup {
	...
	public EAR_U08_SPECIMEN_CONTAINER(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating EAR_U08_SPECIMEN_CONTAINER - this is probably a bug in the source code generator.", e);
	   }
	}
