 ...
 * 1: RXD (Pharmacy/Treatment Dispense) <b></b><br>
 * 2: RXR (Pharmacy/Treatment Route) <b>repeating</b><br>
 * 3: TQ1 (Timing/Quantity) <b></b><br>
 * 4: RXC (Pharmacy/Treatment Component Order) <b>optional repeating</b><br>
 * 5: TQ2 (Timing/Quantity Relationship) <b>optional repeating</b><br>
 */
public class RDR_RDR_DISPENSE extends AbstractGroup {

	/** 
	 * Creates a new RDR_RDR_DISPENSE Group.
	 */
	public RDR_RDR_DISPENSE(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating RDR_RDR_DISPENSE - this is probably a bug in the source code generator.", e);
	   }
	}
