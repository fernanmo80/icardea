 ...
 * 5: RPA_I08_AUTHORIZATION (a Group object) <b>optional </b><br>
 * 6: RPA_I08_PROVIDER (a Group object) <b>repeating</b><br>
 ...
 * 10: RPA_I08_INSURANCE (a Group object) <b>optional repeating</b><br>
 * 11: ACC (Accident) <b>optional </b><br>
 * 12: DG1 (Diagnosis) <b>optional repeating</b><br>
 * 13: DRG (Diagnosis Related Group) <b>optional repeating</b><br>
 * 14: AL1 (Patient Allergy Information) <b>optional repeating</b><br>
 * 15: RPA_I08_PROCEDURE (a Group object) <b>repeating</b><br>
 * 16: RPA_I08_OBSERVATION (a Group object) <b>optional repeating</b><br>
 * 17: RPA_I08_VISIT (a Group object) <b>optional </b><br>
 * 18: NTE (Notes and Comments) <b>optional repeating</b><br>
 */
public class RPA_I08 extends AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating RPA_I08 - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public RPA_I08_AUTHORIZATION getAUTHORIZATION() { 
	   ...
	   try {
	      ret = (RPA_I08_AUTHORIZATION)this.get("AUTHORIZATION");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	...
	public RPA_I08_PROVIDER getPROVIDER() { 
	   ...
	   try {
	      ret = (RPA_I08_PROVIDER)this.get("PROVIDER");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public RPA_I08_PROVIDER getPROVIDER(int rep) throws HL7Exception { 
	   return (RPA_I08_PROVIDER)this.get("PROVIDER", rep);
	}
	...
	/**
	 * Inserts a specific repetition of RPA_I08_PROVIDER
	 * (a Group object)
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	...
	/**
	 * Removes a specific repetition of RPA_I08_PROVIDER
	 * (a Group object)
	 * @see AbstractGroup#insertremoveRepetition(String, int) 
	 */
	...
	public RPA_I08_INSURANCE getINSURANCE() { 
	   ...
	   try {
	      ret = (RPA_I08_INSURANCE)this.get("INSURANCE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public RPA_I08_INSURANCE getINSURANCE(int rep) throws HL7Exception { 
	   return (RPA_I08_INSURANCE)this.get("INSURANCE", rep);
	}
	...
	/**
	 * Inserts a specific repetition of RPA_I08_INSURANCE
	 * (a Group object)
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	...
	/**
	 * Removes a specific repetition of RPA_I08_INSURANCE
	 * (a Group object)
	 * @see AbstractGroup#insertremoveRepetition(String, int) 
	 */
	...
	public RPA_I08_PROCEDURE getPROCEDURE() { 
	   ...
	   try {
	      ret = (RPA_I08_PROCEDURE)this.get("PROCEDURE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public RPA_I08_PROCEDURE getPROCEDURE(int rep) throws HL7Exception { 
	   return (RPA_I08_PROCEDURE)this.get("PROCEDURE", rep);
	}
	...
	/**
	 * Inserts a specific repetition of RPA_I08_PROCEDURE
	 * (a Group object)
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	...
	/**
	 * Removes a specific repetition of RPA_I08_PROCEDURE
	 * (a Group object)
	 * @see AbstractGroup#insertremoveRepetition(String, int) 
	 */
	...
	public RPA_I08_OBSERVATION getOBSERVATION() { 
	   ...
	   try {
	      ret = (RPA_I08_OBSERVATION)this.get("OBSERVATION");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public RPA_I08_OBSERVATION getOBSERVATION(int rep) throws HL7Exception { 
	   return (RPA_I08_OBSERVATION)this.get("OBSERVATION", rep);
	}
	...
	/**
	 * Inserts a specific repetition of RPA_I08_OBSERVATION
	 * (a Group object)
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	...
	/**
	 * Removes a specific repetition of RPA_I08_OBSERVATION
	 * (a Group object)
	 * @see AbstractGroup#insertremoveRepetition(String, int) 
	 */
	...
	public RPA_I08_VISIT getVISIT() { 
	   ...
	   try {
	      ret = (RPA_I08_VISIT)this.get("VISIT");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
