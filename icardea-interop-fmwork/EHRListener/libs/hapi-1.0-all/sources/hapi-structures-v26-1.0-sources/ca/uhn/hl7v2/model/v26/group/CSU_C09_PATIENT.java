...
public class CSU_C09_PATIENT extends AbstractGroup {
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public CSU_C09_STUDY_PHASE getSTUDY_PHASE(int rep) throws HL7Exception { 
	   return (CSU_C09_STUDY_PHASE)this.get("STUDY_PHASE", rep);
	}
	...
	/**
	 * Inserts a specific repetition of CSU_C09_STUDY_PHASE
	 * (a Group object)
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	...
	/**
	 * Removes a specific repetition of CSU_C09_STUDY_PHASE
	 * (a Group object)
	 * @see AbstractGroup#insertremoveRepetition(String, int) 
	 */
