 ...
 * SID-1: Application/Method Identifier (CWE)<br> 
 * SID-2: Substance Lot Number (ST)<br> 
 * SID-3: Substance Container Identifier (ST)<br> 
 * SID-4: Substance Manufacturer Identifier (CWE)<br> 
...
public class SID extends AbstractSegment  {
  ...
  public SID(Group parent, ModelClassFactory factory) {
    ...
    try {
       this.add(CWE.class, false, 1, 705, new Object[]{message}, "Application/Method Identifier");
       this.add(ST.class, false, 1, 20, new Object[]{message}, "Substance Lot Number");
       this.add(ST.class, false, 1, 200, new Object[]{message}, "Substance Container Identifier");
       this.add(CWE.class, false, 1, 705, new Object[]{message}, "Substance Manufacturer Identifier");
