...
public class ORP_O10_ORDER_DETAIL extends AbstractGroup {
	...
	public ORP_O10_ORDER_DETAIL(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      this.add(ORP_O10_COMPONENT.class, false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating ORP_O10_ORDER_DETAIL - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public ORP_O10_COMPONENT getCOMPONENT() { 
	   ...
	   try {
	      ret = (ORP_O10_COMPONENT)this.get("COMPONENT");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public ORP_O10_COMPONENT getCOMPONENT(int rep) throws HL7Exception { 
	   return (ORP_O10_COMPONENT)this.get("COMPONENT", rep);
	}
	...
	/**
	 * Inserts a specific repetition of ORP_O10_COMPONENT
	 * (a Group object)
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	...
	/**
	 * Removes a specific repetition of ORP_O10_COMPONENT
	 * (a Group object)
	 * @see AbstractGroup#insertremoveRepetition(String, int) 
	 */
