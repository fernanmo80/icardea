 ...
 * 6: PMU_B07_CERTIFICATE (a Group object) <b>optional repeating</b><br>
 */
public class PMU_B07 extends AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating PMU_B07 - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public PMU_B07_CERTIFICATE getCERTIFICATE() { 
	   ...
	   try {
	      ret = (PMU_B07_CERTIFICATE)this.get("CERTIFICATE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public PMU_B07_CERTIFICATE getCERTIFICATE(int rep) throws HL7Exception { 
	   return (PMU_B07_CERTIFICATE)this.get("CERTIFICATE", rep);
	}
	...
	/**
	 * Inserts a specific repetition of PMU_B07_CERTIFICATE
	 * (a Group object)
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	...
	/**
	 * Removes a specific repetition of PMU_B07_CERTIFICATE
	 * (a Group object)
	 * @see AbstractGroup#insertremoveRepetition(String, int) 
	 */
