...
public class OMG_O19_SPECIMEN extends AbstractGroup {
	...
	public OMG_O19_SPECIMEN(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      this.add(OMG_O19_CONTAINER.class, false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating OMG_O19_SPECIMEN - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public OMG_O19_CONTAINER getCONTAINER() { 
	   ...
	   try {
	      ret = (OMG_O19_CONTAINER)this.get("CONTAINER");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public OMG_O19_CONTAINER getCONTAINER(int rep) throws HL7Exception { 
	   return (OMG_O19_CONTAINER)this.get("CONTAINER", rep);
	}
	...
	/**
	 * Inserts a specific repetition of OMG_O19_CONTAINER
	 * (a Group object)
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	...
	/**
	 * Removes a specific repetition of OMG_O19_CONTAINER
	 * (a Group object)
	 * @see AbstractGroup#insertremoveRepetition(String, int) 
	 */
