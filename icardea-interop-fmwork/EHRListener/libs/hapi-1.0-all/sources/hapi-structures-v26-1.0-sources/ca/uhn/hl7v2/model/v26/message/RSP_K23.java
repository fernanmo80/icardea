 ...
 * 7: RSP_K23_QUERY_RESPONSE (a Group object) <b>optional </b><br>
...
public class RSP_K23 extends AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating RSP_K23 - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public RSP_K23_QUERY_RESPONSE getQUERY_RESPONSE() { 
	   ...
	   try {
	      ret = (RSP_K23_QUERY_RESPONSE)this.get("QUERY_RESPONSE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
