 ...
 * CM2-2: Scheduled Time Point (CWE)<br> 
 * CM2-3: Description of Time Point (ST)<br> 
 * CM2-4: Events Scheduled This Time Point (CWE)<br> 
...
public class CM2 extends AbstractSegment  {
  ...
  public CM2(Group parent, ModelClassFactory factory) {
    ...
    try {
       this.add(SI.class, false, 1, 4, new Object[]{message}, "Set ID- CM2");
       this.add(CWE.class, true, 1, 250, new Object[]{message}, "Scheduled Time Point");
       this.add(ST.class, false, 1, 300, new Object[]{message}, "Description of Time Point");
       this.add(CWE.class, true, 200, 250, new Object[]{message}, "Events Scheduled This Time Point");
   ...
   */
  public CWE getEventsScheduledThisTimePoint(int rep) throws HL7Exception {
    CWE ret = null;
    try {
  ...
  /**
   * Returns a count of the number of repetitions of Events Scheduled This Time Point (CM2-4).
   */
  ...
  /**
   * Inserts a repetition of Events Scheduled This Time Point (CM2-4) at a given index and returns it.
   * @param index The index
   */
  public CWE insertEventsScheduledThisTimePoint(int index) throws HL7Exception {
     return (CWE) super.insertRepetition(4, index);
  }

  /**
   * Removes a repetition of Events Scheduled This Time Point (CM2-4) at a given index and returns it.
   * @param index The index
   */
  public CWE removeEventsScheduledThisTimePoint(int index) throws HL7Exception {
   ...
   * @throws HL7Exception if the repetition number is invalid.
   */
  public CWE getCm24_EventsScheduledThisTimePoint(int rep) throws HL7Exception {
    CWE ret = null;
    try {
        Type t = this.getField(4, rep);
        ret = (CWE)t;
   ...
   * @param index The index
   */
  public CWE insertCm24_EventsScheduledThisTimePoint(int index) throws HL7Exception {
     return (CWE) super.insertRepetition(4, index);
  }
   ...
   * @param index The index
   */
  public CWE removeCm24_EventsScheduledThisTimePoint(int index) throws HL7Exception {
     return (CWE) super.removeRepetition(4, index);
  }
