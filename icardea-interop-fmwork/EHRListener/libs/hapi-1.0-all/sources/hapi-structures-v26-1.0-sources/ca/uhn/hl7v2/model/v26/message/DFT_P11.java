 ...
 * 11: DFT_P11_COMMON_ORDER (a Group object) <b>optional repeating</b><br>
 ...
 * 15: DFT_P11_INSURANCE (a Group object) <b>optional repeating</b><br>
 * 16: ACC (Accident) <b>optional </b><br>
 * 17: DFT_P11_FINANCIAL (a Group object) <b>repeating</b><br>
 */
public class DFT_P11 extends AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating DFT_P11 - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public DFT_P11_COMMON_ORDER getCOMMON_ORDER() { 
	   ...
	   try {
	      ret = (DFT_P11_COMMON_ORDER)this.get("COMMON_ORDER");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public DFT_P11_COMMON_ORDER getCOMMON_ORDER(int rep) throws HL7Exception { 
	   return (DFT_P11_COMMON_ORDER)this.get("COMMON_ORDER", rep);
	}
	...
	/**
	 * Inserts a specific repetition of DFT_P11_COMMON_ORDER
	 * (a Group object)
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	...
	/**
	 * Removes a specific repetition of DFT_P11_COMMON_ORDER
	 * (a Group object)
	 * @see AbstractGroup#insertremoveRepetition(String, int) 
	 */
	...
	public DFT_P11_INSURANCE getINSURANCE() { 
	   ...
	   try {
	      ret = (DFT_P11_INSURANCE)this.get("INSURANCE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public DFT_P11_INSURANCE getINSURANCE(int rep) throws HL7Exception { 
	   return (DFT_P11_INSURANCE)this.get("INSURANCE", rep);
	}
	...
	/**
	 * Inserts a specific repetition of DFT_P11_INSURANCE
	 * (a Group object)
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	...
	/**
	 * Removes a specific repetition of DFT_P11_INSURANCE
	 * (a Group object)
	 * @see AbstractGroup#insertremoveRepetition(String, int) 
	 */
	...
	public DFT_P11_FINANCIAL getFINANCIAL() { 
	   ...
	   try {
	      ret = (DFT_P11_FINANCIAL)this.get("FINANCIAL");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public DFT_P11_FINANCIAL getFINANCIAL(int rep) throws HL7Exception { 
	   return (DFT_P11_FINANCIAL)this.get("FINANCIAL", rep);
	}
	...
	/**
	 * Inserts a specific repetition of DFT_P11_FINANCIAL
	 * (a Group object)
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	...
	/**
	 * Removes a specific repetition of DFT_P11_FINANCIAL
	 * (a Group object)
	 * @see AbstractGroup#insertremoveRepetition(String, int) 
	 */
