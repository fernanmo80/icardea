 ...
 * NDS-2: Notification Date/Time (DTM)<br> 
 * NDS-3: Notification Alert Severity (CWE)<br> 
 * NDS-4: Notification Code (CWE)<br> 
...
public class NDS extends AbstractSegment  {
  ...
  public NDS(Group parent, ModelClassFactory factory) {
    ...
    try {
       this.add(NM.class, true, 1, 20, new Object[]{message}, "Notification Reference Number");
       this.add(DTM.class, true, 1, 24, new Object[]{message}, "Notification Date/Time");
       this.add(CWE.class, true, 1, 705, new Object[]{message}, "Notification Alert Severity");
       this.add(CWE.class, true, 1, 705, new Object[]{message}, "Notification Code");
