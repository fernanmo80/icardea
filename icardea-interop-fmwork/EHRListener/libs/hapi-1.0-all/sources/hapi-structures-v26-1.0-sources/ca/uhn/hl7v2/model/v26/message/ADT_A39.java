 ...
 * 4: ADT_A39_PATIENT (a Group object) <b>repeating</b><br>
 */
public class ADT_A39 extends AbstractMessage  {
	...
	public ADT_A39_PATIENT getPATIENT() { 
	   ...
	   try {
	      ret = (ADT_A39_PATIENT)this.get("PATIENT");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public ADT_A39_PATIENT getPATIENT(int rep) throws HL7Exception { 
	   return (ADT_A39_PATIENT)this.get("PATIENT", rep);
	}
	...
	/**
	 * Inserts a specific repetition of ADT_A39_PATIENT
	 * (a Group object)
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	...
	/**
	 * Removes a specific repetition of ADT_A39_PATIENT
	 * (a Group object)
	 * @see AbstractGroup#insertremoveRepetition(String, int) 
	 */
