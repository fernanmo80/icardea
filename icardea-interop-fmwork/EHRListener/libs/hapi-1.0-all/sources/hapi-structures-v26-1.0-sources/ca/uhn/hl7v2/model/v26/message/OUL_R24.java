 ...
 * 4: OUL_R24_PATIENT (a Group object) <b>optional </b><br>
 * 5: NK1 (Next of Kin / Associated Parties) <b>optional repeating</b><br>
 * 6: OUL_R24_ORDER (a Group object) <b>repeating</b><br>
...
public class OUL_R24 extends AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating OUL_R24 - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public OUL_R24_PATIENT getPATIENT() { 
	   ...
	   try {
	      ret = (OUL_R24_PATIENT)this.get("PATIENT");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	...
	public OUL_R24_ORDER getORDER() { 
	   ...
	   try {
	      ret = (OUL_R24_ORDER)this.get("ORDER");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public OUL_R24_ORDER getORDER(int rep) throws HL7Exception { 
	   return (OUL_R24_ORDER)this.get("ORDER", rep);
	}
	...
	/**
	 * Inserts a specific repetition of OUL_R24_ORDER
	 * (a Group object)
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	...
	/**
	 * Removes a specific repetition of OUL_R24_ORDER
	 * (a Group object)
	 * @see AbstractGroup#insertremoveRepetition(String, int) 
	 */
