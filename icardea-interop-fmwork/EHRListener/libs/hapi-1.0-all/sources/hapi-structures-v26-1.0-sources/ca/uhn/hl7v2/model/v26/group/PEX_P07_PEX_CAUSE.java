...
public class PEX_P07_PEX_CAUSE extends AbstractGroup {
	 ...
	 */
	public PEX_P07_RX_ADMINISTRATION getRX_ADMINISTRATION(int rep) throws HL7Exception { 
	   return (PEX_P07_RX_ADMINISTRATION)this.get("RX_ADMINISTRATION", rep);
	}
	...
	/**
	 * Inserts a specific repetition of PEX_P07_RX_ADMINISTRATION
	 * (a Group object)
	...
	/**
	 * Removes a specific repetition of PEX_P07_RX_ADMINISTRATION
	 * (a Group object)
	...
	/**
	 * Inserts a specific repetition of PRB
	 * (Problem Details)
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	...
	/**
	 * Removes a specific repetition of PRB
	 * (Problem Details)
	 * @see AbstractGroup#insertremoveRepetition(String, int) 
	 */
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public PEX_P07_STUDY getSTUDY(int rep) throws HL7Exception { 
	   return (PEX_P07_STUDY)this.get("STUDY", rep);
	}
	...
	/**
	 * Inserts a specific repetition of PEX_P07_STUDY
	 * (a Group object)
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	...
	/**
	 * Removes a specific repetition of PEX_P07_STUDY
	 * (a Group object)
	 * @see AbstractGroup#insertremoveRepetition(String, int) 
	 */
