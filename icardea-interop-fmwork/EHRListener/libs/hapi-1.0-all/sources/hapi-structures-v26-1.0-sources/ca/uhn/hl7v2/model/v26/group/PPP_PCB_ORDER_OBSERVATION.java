...
public class PPP_PCB_ORDER_OBSERVATION extends AbstractGroup {
	...
	public PPP_PCB_ORDER_OBSERVATION(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating PPP_PCB_ORDER_OBSERVATION - this is probably a bug in the source code generator.", e);
	   }
	}
