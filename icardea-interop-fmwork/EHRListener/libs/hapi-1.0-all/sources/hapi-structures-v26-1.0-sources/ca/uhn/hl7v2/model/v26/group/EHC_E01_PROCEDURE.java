...
/**
 * <p>Represents the EHC_E01_PROCEDURE Group.  A Group is an ordered collection of message 
 ...
 */
public class EHC_E01_PROCEDURE extends AbstractGroup {

	/** 
	 * Creates a new EHC_E01_PROCEDURE Group.
	 */
	public EHC_E01_PROCEDURE(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating EHC_E01_PROCEDURE - this is probably a bug in the source code generator.", e);
	   }
	}
