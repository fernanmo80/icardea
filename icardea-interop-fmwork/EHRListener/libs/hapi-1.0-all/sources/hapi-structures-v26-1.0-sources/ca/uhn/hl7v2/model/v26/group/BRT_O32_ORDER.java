...
public class BRT_O32_ORDER extends AbstractGroup {
	...
	/**
	 * Inserts a specific repetition of BRT_O32_TIMING
	 * (a Group object)
	...
	/**
	 * Removes a specific repetition of BRT_O32_TIMING
	 * (a Group object)
	...
	/**
	 * Inserts a specific repetition of BTX
	...
	/**
	 * Removes a specific repetition of BTX
	 * (Blood Product Transfusion/Disposition)
	 * @see AbstractGroup#insertremoveRepetition(String, int) 
	 */
