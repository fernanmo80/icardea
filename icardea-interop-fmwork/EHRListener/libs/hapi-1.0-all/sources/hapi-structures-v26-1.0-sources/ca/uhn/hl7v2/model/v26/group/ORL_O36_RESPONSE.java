...
public class ORL_O36_RESPONSE extends AbstractGroup {
	...
	public ORL_O36_RESPONSE(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      this.add(ORL_O36_SPECIMEN.class, true, true);
	...
	public ORL_O36_SPECIMEN getSPECIMEN() { 
	   ...
	   try {
	      ret = (ORL_O36_SPECIMEN)this.get("SPECIMEN");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 */
	public ORL_O36_SPECIMEN getSPECIMEN(int rep) throws HL7Exception { 
	   return (ORL_O36_SPECIMEN)this.get("SPECIMEN", rep);
	}
	...
	/**
	 * Inserts a specific repetition of ORL_O36_SPECIMEN
	 * (a Group object)
	...
	/**
	 * Removes a specific repetition of ORL_O36_SPECIMEN
	 * (a Group object)
