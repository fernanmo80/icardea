 ...
 * QAK-3: Message Query Name (CWE)<br> 
...
public class QAK extends AbstractSegment  {
  ...
  public QAK(Group parent, ModelClassFactory factory) {
    ...
    try {
       this.add(ST.class, false, 1, 32, new Object[]{message}, "Query Tag");
       this.add(ID.class, false, 1, 2, new Object[]{message, new Integer(208)}, "Query Response Status");
       this.add(CWE.class, false, 1, 250, new Object[]{message}, "Message Query Name");
       this.add(NM.class, false, 1, 10, new Object[]{message}, "Hit Count Total");
       this.add(NM.class, false, 1, 10, new Object[]{message}, "This payload");
       this.add(NM.class, false, 1, 10, new Object[]{message}, "Hits remaining");
  ...
  public NM getQak6_HitsRemaining()  {
   ...
   protected Type createNewTypeWithoutReflection(int field) {
      switch (field) {
         ...
         case 1: return new ca.uhn.hl7v2.model.v26.datatype.ID(getMessage(), new Integer(208));
