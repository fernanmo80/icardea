...
/**
 * <p>Represents the MFN_M17_MF_DRG Group.  A Group is an ordered collection of message 
 * segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements: </p>
 * 0: MFE (Master File Entry) <b></b><br>
 * 1: DMI (DRG Master File Information) <b></b><br>
 */
public class MFN_M17_MF_DRG extends AbstractGroup {
	...
	public MFN_M17_MF_DRG(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating MFN_M17_MF_DRG - this is probably a bug in the source code generator.", e);
	   }
	}
