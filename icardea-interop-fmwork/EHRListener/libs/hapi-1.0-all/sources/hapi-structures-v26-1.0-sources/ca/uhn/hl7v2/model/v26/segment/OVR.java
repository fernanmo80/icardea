...
public class OVR extends AbstractSegment  {
  ...
  public OVR(Group parent, ModelClassFactory factory) {
    ...
    try {
       this.add(CWE.class, false, 1, 705, new Object[]{message}, "Business Rule Override Type");
       this.add(CWE.class, false, 1, 705, new Object[]{message}, "Business Rule Override Code");
       this.add(TX.class, false, 1, 200, new Object[]{message}, "Override Comments");
       this.add(XCN.class, false, 1, 250, new Object[]{message}, "Override Entered By");
       this.add(XCN.class, false, 1, 250, new Object[]{message}, "Override Authorized By");
