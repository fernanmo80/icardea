...
public class OML_O21_SPECIMEN extends AbstractGroup {
	...
	public OML_O21_SPECIMEN(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      this.add(OML_O21_CONTAINER.class, false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating OML_O21_SPECIMEN - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public OML_O21_CONTAINER getCONTAINER() { 
	   ...
	   try {
	      ret = (OML_O21_CONTAINER)this.get("CONTAINER");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public OML_O21_CONTAINER getCONTAINER(int rep) throws HL7Exception { 
	   return (OML_O21_CONTAINER)this.get("CONTAINER", rep);
	}
	...
	/**
	 * Inserts a specific repetition of OML_O21_CONTAINER
	 * (a Group object)
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	...
	/**
	 * Removes a specific repetition of OML_O21_CONTAINER
	 * (a Group object)
	 * @see AbstractGroup#insertremoveRepetition(String, int) 
	 */
