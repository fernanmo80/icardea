 ...
 * PTH-2: Pathway ID (CWE)<br> 
 * PTH-3: Pathway Instance ID (EI)<br> 
 * PTH-4: Pathway Established Date/Time (DTM)<br> 
 * PTH-5: Pathway Life Cycle Status (CWE)<br> 
 * PTH-6: Change Pathway Life Cycle Status Date/Time (DTM)<br> 
 * PTH-7: Mood Code (CNE)<br> 
...
public class PTH extends AbstractSegment  {
  ...
  public PTH(Group parent, ModelClassFactory factory) {
    ...
    try {
       ...
       this.add(CWE.class, true, 1, 705, new Object[]{message}, "Pathway ID");
       this.add(EI.class, true, 1, 60, new Object[]{message}, "Pathway Instance ID");
       this.add(DTM.class, true, 1, 24, new Object[]{message}, "Pathway Established Date/Time");
       this.add(CWE.class, false, 1, 705, new Object[]{message}, "Pathway Life Cycle Status");
       this.add(DTM.class, false, 1, 24, new Object[]{message}, "Change Pathway Life Cycle Status Date/Time");
