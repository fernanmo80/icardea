 ...
 * 4: SFT (Software Segment) <b>optional </b><br>
 * 5: UAC (User Authentication Credential Segment) <b>optional </b><br>
 * 6: RDR_RDR_DEFINITION (a Group object) <b>repeating</b><br>
 * 7: RXC (Pharmacy/Treatment Component Order) <b>optional repeating</b><br>
 * 8: DSC (Continuation Pointer) <b>optional </b><br>
 * 9: RXD (Pharmacy/Treatment Dispense) <b></b><br>
 * 10: RXR (Pharmacy/Treatment Route) <b>repeating</b><br>
 * 11: RXC (Pharmacy/Treatment Component Order) <b>optional repeating</b><br>
...
public class RDR_RDR extends AbstractMessage  {
	...
	public RDR_RDR_DEFINITION getDEFINITION() { 
	   ...
	   try {
	      ret = (RDR_RDR_DEFINITION)this.get("DEFINITION");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public RDR_RDR_DEFINITION getDEFINITION(int rep) throws HL7Exception { 
	   return (RDR_RDR_DEFINITION)this.get("DEFINITION", rep);
	}
	...
	/**
	 * Inserts a specific repetition of RDR_RDR_DEFINITION
	 * (a Group object)
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	...
	/**
	 * Removes a specific repetition of RDR_RDR_DEFINITION
	 * (a Group object)
	 * @see AbstractGroup#insertremoveRepetition(String, int) 
	 */
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public RXC getRXC2(int rep) throws HL7Exception { 
	   return (RXC)this.get("RXC2", rep);
	}
	...
	/**
	 * Inserts a specific repetition of RXC2
	 * (Pharmacy/Treatment Component Order)
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	...
	/**
	 * Removes a specific repetition of RXC2
	 * (Pharmacy/Treatment Component Order)
	 * @see AbstractGroup#insertremoveRepetition(String, int) 
	 */
