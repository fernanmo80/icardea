 ...
 * 4: OUL_R23_TIMING_QTY (a Group object) <b>optional repeating</b><br>
 * 5: OUL_R23_RESULT (a Group object) <b>optional repeating</b><br>
...
public class OUL_R23_ORDER extends AbstractGroup {
	...
	public OUL_R23_ORDER(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      this.add(OUL_R23_TIMING_QTY.class, false, true);
	      this.add(OUL_R23_RESULT.class, false, true);
	      this.add(CTI.class, false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating OUL_R23_ORDER - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public OUL_R23_TIMING_QTY getTIMING_QTY() { 
	   ...
	   try {
	      ret = (OUL_R23_TIMING_QTY)this.get("TIMING_QTY");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public OUL_R23_TIMING_QTY getTIMING_QTY(int rep) throws HL7Exception { 
	   return (OUL_R23_TIMING_QTY)this.get("TIMING_QTY", rep);
	}
	...
	/**
	 * Inserts a specific repetition of OUL_R23_TIMING_QTY
	 * (a Group object)
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	...
	/**
	 * Removes a specific repetition of OUL_R23_TIMING_QTY
	 * (a Group object)
	 * @see AbstractGroup#insertremoveRepetition(String, int) 
	 */
	...
	public OUL_R23_RESULT getRESULT() { 
	   ...
	   try {
	      ret = (OUL_R23_RESULT)this.get("RESULT");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public OUL_R23_RESULT getRESULT(int rep) throws HL7Exception { 
	   return (OUL_R23_RESULT)this.get("RESULT", rep);
	}
	...
	/**
	 * Inserts a specific repetition of OUL_R23_RESULT
	 * (a Group object)
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	...
	/**
	 * Removes a specific repetition of OUL_R23_RESULT
	 * (a Group object)
	 * @see AbstractGroup#insertremoveRepetition(String, int) 
	 */
