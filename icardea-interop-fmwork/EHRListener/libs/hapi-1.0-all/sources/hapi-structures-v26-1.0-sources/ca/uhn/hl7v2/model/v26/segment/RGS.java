 ...
 * RGS-3: Resource Group ID (CWE)<br> 
...
public class RGS extends AbstractSegment  {
  ...
  public RGS(Group parent, ModelClassFactory factory) {
    ...
    try {
       this.add(SI.class, true, 1, 4, new Object[]{message}, "Set ID - RGS");
       this.add(ID.class, false, 1, 3, new Object[]{message, new Integer(206)}, "Segment Action Code");
       this.add(CWE.class, false, 1, 250, new Object[]{message}, "Resource Group ID");
