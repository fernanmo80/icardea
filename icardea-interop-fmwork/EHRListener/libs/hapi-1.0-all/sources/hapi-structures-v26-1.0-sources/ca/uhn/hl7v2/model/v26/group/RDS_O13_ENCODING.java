...
public class RDS_O13_ENCODING extends AbstractGroup {
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public RDS_O13_TIMING_ENCODED getTIMING_ENCODED(int rep) throws HL7Exception { 
	   return (RDS_O13_TIMING_ENCODED)this.get("TIMING_ENCODED", rep);
	}
	...
	/**
	 * Inserts a specific repetition of RDS_O13_TIMING_ENCODED
	 * (a Group object)
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	...
	/**
	 * Removes a specific repetition of RDS_O13_TIMING_ENCODED
	 * (a Group object)
	 * @see AbstractGroup#insertremoveRepetition(String, int) 
	 */
