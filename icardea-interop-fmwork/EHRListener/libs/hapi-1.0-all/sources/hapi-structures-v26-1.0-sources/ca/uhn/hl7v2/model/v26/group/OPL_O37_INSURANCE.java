...
/**
 * <p>Represents the OPL_O37_INSURANCE Group.  A Group is an ordered collection of message 
...
public class OPL_O37_INSURANCE extends AbstractGroup {
	 ...
	 */
	public OPL_O37_INSURANCE(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating OPL_O37_INSURANCE - this is probably a bug in the source code generator.", e);
	   }
	}
