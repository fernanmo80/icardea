...
public class OMS_O05_ORDER extends AbstractGroup {
	...
	public OMS_O05_ORDER(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating OMS_O05_ORDER - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public OMS_O05_TIMING getTIMING() { 
	   ...
	   try {
	      ret = (OMS_O05_TIMING)this.get("TIMING");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 */
	public OMS_O05_TIMING getTIMING(int rep) throws HL7Exception { 
	   return (OMS_O05_TIMING)this.get("TIMING", rep);
	}
	...
	/**
	 * Inserts a specific repetition of OMS_O05_TIMING
	 * (a Group object)
	...
	/**
	 * Removes a specific repetition of OMS_O05_TIMING
	 * (a Group object)
	...
	public OMS_O05_OBSERVATION getOBSERVATION() { 
	   ...
	   try {
	      ret = (OMS_O05_OBSERVATION)this.get("OBSERVATION");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public OMS_O05_OBSERVATION getOBSERVATION(int rep) throws HL7Exception { 
	   return (OMS_O05_OBSERVATION)this.get("OBSERVATION", rep);
	}
	...
	/**
	 * Inserts a specific repetition of OMS_O05_OBSERVATION
	 * (a Group object)
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	...
	/**
	 * Removes a specific repetition of OMS_O05_OBSERVATION
	 * (a Group object)
	 * @see AbstractGroup#insertremoveRepetition(String, int) 
	 */
