...
public class DSP extends AbstractSegment  {
  ...
  public DSP(Group parent, ModelClassFactory factory) {
    ...
    try {
       this.add(SI.class, false, 1, 4, new Object[]{message}, "Set ID - DSP");
       this.add(SI.class, false, 1, 4, new Object[]{message}, "Display Level");
       this.add(TX.class, true, 1, 300, new Object[]{message}, "Data Line");
       this.add(ST.class, false, 1, 2, new Object[]{message}, "Logical Break Point");
       this.add(TX.class, false, 1, 20, new Object[]{message}, "Result ID");
  ...
  public TX getDsp5_ResultID()  {
   ...
   protected Type createNewTypeWithoutReflection(int field) {
      switch (field) {
         ...
         case 1: return new ca.uhn.hl7v2.model.v26.datatype.SI(getMessage());
