...
public class RAS_O17_ENCODING extends AbstractGroup {
	...
	public RAS_O17_ENCODING(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      this.add(RAS_O17_TIMING_ENCODED.class, true, true);
	      this.add(RXR.class, true, true);
	      this.add(RXC.class, false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating RAS_O17_ENCODING - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public RAS_O17_TIMING_ENCODED getTIMING_ENCODED() { 
	   ...
	   try {
	      ret = (RAS_O17_TIMING_ENCODED)this.get("TIMING_ENCODED");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 */
	public RAS_O17_TIMING_ENCODED getTIMING_ENCODED(int rep) throws HL7Exception { 
	   return (RAS_O17_TIMING_ENCODED)this.get("TIMING_ENCODED", rep);
	}
	...
	/**
	 * Inserts a specific repetition of RAS_O17_TIMING_ENCODED
	 * (a Group object)
	...
	/**
	 * Removes a specific repetition of RAS_O17_TIMING_ENCODED
	 * (a Group object)
