...
public class RSP_Z88_ORDER_DETAIL extends AbstractGroup {
	...
	public RSP_Z88_ORDER_DETAIL(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      this.add(RSP_Z88_COMPONENT.class, false, false);
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating RSP_Z88_ORDER_DETAIL - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public RSP_Z88_COMPONENT getCOMPONENT() { 
	   ...
	   try {
	      ret = (RSP_Z88_COMPONENT)this.get("COMPONENT");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
