...
/**
 * <p>Represents the EHC_E01_PRODUCT_SERVICE_SECTION Group.  A Group is an ordered collection of message 
 * segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements: </p>
 * 0: PSS (Product/Service Section) <b></b><br>
 * 1: EHC_E01_PRODUCT_SERVICE_GROUP (a Group object) <b>repeating</b><br>
 */
public class EHC_E01_PRODUCT_SERVICE_SECTION extends AbstractGroup {
	...
	public EHC_E01_PRODUCT_SERVICE_SECTION(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      this.add(EHC_E01_PRODUCT_SERVICE_GROUP.class, true, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating EHC_E01_PRODUCT_SERVICE_SECTION - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public EHC_E01_PRODUCT_SERVICE_GROUP getPRODUCT_SERVICE_GROUP() { 
	   ...
	   try {
	      ret = (EHC_E01_PRODUCT_SERVICE_GROUP)this.get("PRODUCT_SERVICE_GROUP");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 */
	public EHC_E01_PRODUCT_SERVICE_GROUP getPRODUCT_SERVICE_GROUP(int rep) throws HL7Exception { 
	   return (EHC_E01_PRODUCT_SERVICE_GROUP)this.get("PRODUCT_SERVICE_GROUP", rep);
	}
	...
	/**
	 * Inserts a specific repetition of EHC_E01_PRODUCT_SERVICE_GROUP
	 * (a Group object)
	...
	/**
	 * Removes a specific repetition of EHC_E01_PRODUCT_SERVICE_GROUP
	 * (a Group object)
