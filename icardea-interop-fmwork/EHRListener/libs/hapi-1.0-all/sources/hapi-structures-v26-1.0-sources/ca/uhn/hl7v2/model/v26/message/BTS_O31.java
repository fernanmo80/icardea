 ...
 * 4: BTS_O31_PATIENT (a Group object) <b>optional </b><br>
 * 5: BTS_O31_ORDER (a Group object) <b>repeating</b><br>
 */
public class BTS_O31 extends AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating BTS_O31 - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public BTS_O31_PATIENT getPATIENT() { 
	   ...
	   try {
	      ret = (BTS_O31_PATIENT)this.get("PATIENT");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	...
	public BTS_O31_ORDER getORDER() { 
	   ...
	   try {
	      ret = (BTS_O31_ORDER)this.get("ORDER");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public BTS_O31_ORDER getORDER(int rep) throws HL7Exception { 
	   return (BTS_O31_ORDER)this.get("ORDER", rep);
	}
	...
	/**
	 * Inserts a specific repetition of BTS_O31_ORDER
	 * (a Group object)
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	...
	/**
	 * Removes a specific repetition of BTS_O31_ORDER
	 * (a Group object)
	 * @see AbstractGroup#insertremoveRepetition(String, int) 
	 */
