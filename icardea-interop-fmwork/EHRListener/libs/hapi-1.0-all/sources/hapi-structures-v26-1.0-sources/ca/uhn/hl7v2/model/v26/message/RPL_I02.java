 ...
 * 4: RPL_I02_PROVIDER (a Group object) <b>repeating</b><br>
...
public class RPL_I02 extends AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating RPL_I02 - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public RPL_I02_PROVIDER getPROVIDER() { 
	   ...
	   try {
	      ret = (RPL_I02_PROVIDER)this.get("PROVIDER");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public RPL_I02_PROVIDER getPROVIDER(int rep) throws HL7Exception { 
	   return (RPL_I02_PROVIDER)this.get("PROVIDER", rep);
	}
	...
	/**
	 * Inserts a specific repetition of RPL_I02_PROVIDER
	 * (a Group object)
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	...
	/**
	 * Removes a specific repetition of RPL_I02_PROVIDER
	 * (a Group object)
	 * @see AbstractGroup#insertremoveRepetition(String, int) 
	 */
