...
public class RSP_Z90_QUERY_RESPONSE extends AbstractGroup {
	 ...
	 */
	public RSP_Z90_COMMON_ORDER getCOMMON_ORDER(int rep) throws HL7Exception { 
	   return (RSP_Z90_COMMON_ORDER)this.get("COMMON_ORDER", rep);
	}
	...
	/**
	 * Inserts a specific repetition of RSP_Z90_COMMON_ORDER
	 * (a Group object)
	...
	/**
	 * Removes a specific repetition of RSP_Z90_COMMON_ORDER
	 * (a Group object)
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public RSP_Z90_SPECIMEN getSPECIMEN(int rep) throws HL7Exception { 
	   return (RSP_Z90_SPECIMEN)this.get("SPECIMEN", rep);
	}
	...
	/**
	 * Inserts a specific repetition of RSP_Z90_SPECIMEN
	 * (a Group object)
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	...
	/**
	 * Removes a specific repetition of RSP_Z90_SPECIMEN
	 * (a Group object)
	 * @see AbstractGroup#insertremoveRepetition(String, int) 
	 */
