 ...
 * 4: OML_O35_TIMING_PRIOR (a Group object) <b>optional repeating</b><br>
 * 5: OML_O35_OBSERVATION_PRIOR (a Group object) <b>repeating</b><br>
 */
public class OML_O35_ORDER_PRIOR extends AbstractGroup {
	...
	public OML_O35_ORDER_PRIOR(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating OML_O35_ORDER_PRIOR - this is probably a bug in the source code generator.", e);
	   }
	}
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public OML_O35_TIMING_PRIOR getTIMING_PRIOR(int rep) throws HL7Exception { 
	   return (OML_O35_TIMING_PRIOR)this.get("TIMING_PRIOR", rep);
	}
	...
	/**
	 * Inserts a specific repetition of OML_O35_TIMING_PRIOR
	 * (a Group object)
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	...
	/**
	 * Removes a specific repetition of OML_O35_TIMING_PRIOR
	 * (a Group object)
	 * @see AbstractGroup#insertremoveRepetition(String, int) 
	 */
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public OML_O35_OBSERVATION_PRIOR getOBSERVATION_PRIOR(int rep) throws HL7Exception { 
	   return (OML_O35_OBSERVATION_PRIOR)this.get("OBSERVATION_PRIOR", rep);
	}
	...
	/**
	 * Inserts a specific repetition of OML_O35_OBSERVATION_PRIOR
	 * (a Group object)
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	...
	/**
	 * Removes a specific repetition of OML_O35_OBSERVATION_PRIOR
	 * (a Group object)
	 * @see AbstractGroup#insertremoveRepetition(String, int) 
	 */
