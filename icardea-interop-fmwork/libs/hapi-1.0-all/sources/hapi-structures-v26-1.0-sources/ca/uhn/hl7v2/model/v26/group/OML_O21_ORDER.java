...
public class OML_O21_ORDER extends AbstractGroup {
	...
	public OML_O21_ORDER(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      this.add(OML_O21_TIIMING.class, false, true);
	...
	public OML_O21_TIIMING getTIIMING() { 
	   ...
	   try {
	      ret = (OML_O21_TIIMING)this.get("TIIMING");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 */
	public OML_O21_TIIMING getTIIMING(int rep) throws HL7Exception { 
	   return (OML_O21_TIIMING)this.get("TIIMING", rep);
	}
	...
	/**
	 * Inserts a specific repetition of OML_O21_TIIMING
	 * (a Group object)
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	public void  insertTIIMING(OML_O21_TIIMING structure, int rep) throws HL7Exception { 
	 ...
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	public OML_O21_TIIMING insertTIIMING(int rep) throws HL7Exception { 
	   return (OML_O21_TIIMING)super.insertRepetition("TIIMING", rep);
	}

	/**
	 * Removes a specific repetition of OML_O21_TIIMING
	 * (a Group object)
	 * @see AbstractGroup#insertremoveRepetition(String, int) 
	 */
	public OML_O21_TIIMING removeTIIMING(int rep) throws HL7Exception { 
	   return (OML_O21_TIIMING)super.removeRepetition("TIIMING", rep);
	}
