 ...
 */
public class OML_O21_TIIMING extends AbstractGroup {

	/** 
	 * Creates a new OML_O21_TIIMING Group.
	 */
	public OML_O21_TIIMING(Group parent, ModelClassFactory factory) {
	   super(parent, factory);
	   try {
	      this.add(TQ1.class, true, false);
	      this.add(TQ2.class, false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating OML_O21_TIIMING - this is probably a bug in the source code generator.", e);
	   }
	}
