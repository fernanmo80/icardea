...
/**
 * <p>Represents a QBP_E03 message structure (see chapter 16.3.3). This structure contains the 
 ...
 */
public class QBP_E03 extends AbstractMessage  {

	/** 
	 * Creates a new QBP_E03 Group with custom ModelClassFactory.
	 */
	public QBP_E03(ModelClassFactory factory) {
	   super(factory);
	   init(factory);
	}
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating QBP_E03 - this is probably a bug in the source code generator.", e);
	   }
	}
