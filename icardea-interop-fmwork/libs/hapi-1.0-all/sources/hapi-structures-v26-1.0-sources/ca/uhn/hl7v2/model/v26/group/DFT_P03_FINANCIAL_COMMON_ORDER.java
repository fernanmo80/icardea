...
public class DFT_P03_FINANCIAL_COMMON_ORDER extends AbstractGroup {
	...
	public DFT_P03_FINANCIAL_COMMON_ORDER(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      this.add(DFT_P03_FINANCIAL_TIMING_QUANTITY.class, false, true);
	...
	public DFT_P03_FINANCIAL_TIMING_QUANTITY getFINANCIAL_TIMING_QUANTITY() { 
	   ...
	   try {
	      ret = (DFT_P03_FINANCIAL_TIMING_QUANTITY)this.get("FINANCIAL_TIMING_QUANTITY");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 */
	public DFT_P03_FINANCIAL_TIMING_QUANTITY getFINANCIAL_TIMING_QUANTITY(int rep) throws HL7Exception { 
	   return (DFT_P03_FINANCIAL_TIMING_QUANTITY)this.get("FINANCIAL_TIMING_QUANTITY", rep);
	}
	...
	/**
	 * Inserts a specific repetition of DFT_P03_FINANCIAL_TIMING_QUANTITY
	 * (a Group object)
	...
	/**
	 * Removes a specific repetition of DFT_P03_FINANCIAL_TIMING_QUANTITY
	 * (a Group object)
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public DFT_P03_FINANCIAL_OBSERVATION getFINANCIAL_OBSERVATION(int rep) throws HL7Exception { 
	   return (DFT_P03_FINANCIAL_OBSERVATION)this.get("FINANCIAL_OBSERVATION", rep);
	}
	...
	/**
	 * Inserts a specific repetition of DFT_P03_FINANCIAL_OBSERVATION
	 * (a Group object)
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	...
	/**
	 * Removes a specific repetition of DFT_P03_FINANCIAL_OBSERVATION
	 * (a Group object)
	 * @see AbstractGroup#insertremoveRepetition(String, int) 
	 */
