...
public class RGV_O15_PATIENT extends AbstractGroup {
	...
	public RGV_O15_PATIENT(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      this.add(RGV_O15_PATIENT_VISIT.class, false, false);
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating RGV_O15_PATIENT - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public RGV_O15_PATIENT_VISIT getPATIENT_VISIT() { 
	   ...
	   try {
	      ret = (RGV_O15_PATIENT_VISIT)this.get("PATIENT_VISIT");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
