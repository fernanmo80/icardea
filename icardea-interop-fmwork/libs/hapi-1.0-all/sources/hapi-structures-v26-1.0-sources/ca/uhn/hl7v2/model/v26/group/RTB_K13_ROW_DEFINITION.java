...
public class RTB_K13_ROW_DEFINITION extends AbstractGroup {
	...
	public RTB_K13_ROW_DEFINITION(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating RTB_K13_ROW_DEFINITION - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	/**
	 * Inserts a specific repetition of RDT
	 * (Table Row Data)
	...
	/**
	 * Removes a specific repetition of RDT
	 * (Table Row Data)
