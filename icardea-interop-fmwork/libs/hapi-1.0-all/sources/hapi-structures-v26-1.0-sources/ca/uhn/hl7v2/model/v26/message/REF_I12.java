 ...
 * 4: REF_I12_AUTHORIZATION_CONTACT (a Group object) <b>optional </b><br>
 * 5: REF_I12_PROVIDER_CONTACT (a Group object) <b>repeating</b><br>
 ...
 * 9: REF_I12_INSURANCE (a Group object) <b>optional repeating</b><br>
 ...
 * 14: REF_I12_PROCEDURE (a Group object) <b>optional repeating</b><br>
 * 15: REF_I12_OBSERVATION (a Group object) <b>optional repeating</b><br>
 * 16: REF_I12_PATIENT_VISIT (a Group object) <b>optional </b><br>
...
public class REF_I12 extends AbstractMessage  {
	...
	public REF_I12_PROVIDER_CONTACT getPROVIDER_CONTACT() { 
	   ...
	   try {
	      ret = (REF_I12_PROVIDER_CONTACT)this.get("PROVIDER_CONTACT");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public REF_I12_PROVIDER_CONTACT getPROVIDER_CONTACT(int rep) throws HL7Exception { 
	   return (REF_I12_PROVIDER_CONTACT)this.get("PROVIDER_CONTACT", rep);
	}
	...
	/**
	 * Inserts a specific repetition of REF_I12_PROVIDER_CONTACT
	 * (a Group object)
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	...
	/**
	 * Removes a specific repetition of REF_I12_PROVIDER_CONTACT
	 * (a Group object)
	 * @see AbstractGroup#insertremoveRepetition(String, int) 
	 */
	...
	public REF_I12_INSURANCE getINSURANCE() { 
	   ...
	   try {
	      ret = (REF_I12_INSURANCE)this.get("INSURANCE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public REF_I12_INSURANCE getINSURANCE(int rep) throws HL7Exception { 
	   return (REF_I12_INSURANCE)this.get("INSURANCE", rep);
	}
	...
	/**
	 * Inserts a specific repetition of REF_I12_INSURANCE
	 * (a Group object)
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	...
	/**
	 * Removes a specific repetition of REF_I12_INSURANCE
	 * (a Group object)
	 * @see AbstractGroup#insertremoveRepetition(String, int) 
	 */
	...
	public REF_I12_PROCEDURE getPROCEDURE() { 
	   ...
	   try {
	      ret = (REF_I12_PROCEDURE)this.get("PROCEDURE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public REF_I12_PROCEDURE getPROCEDURE(int rep) throws HL7Exception { 
	   return (REF_I12_PROCEDURE)this.get("PROCEDURE", rep);
	}
	...
	/**
	 * Inserts a specific repetition of REF_I12_PROCEDURE
	 * (a Group object)
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	...
	/**
	 * Removes a specific repetition of REF_I12_PROCEDURE
	 * (a Group object)
	 * @see AbstractGroup#insertremoveRepetition(String, int) 
	 */
	...
	public REF_I12_OBSERVATION getOBSERVATION() { 
	   ...
	   try {
	      ret = (REF_I12_OBSERVATION)this.get("OBSERVATION");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public REF_I12_OBSERVATION getOBSERVATION(int rep) throws HL7Exception { 
	   return (REF_I12_OBSERVATION)this.get("OBSERVATION", rep);
	}
	...
	/**
	 * Inserts a specific repetition of REF_I12_OBSERVATION
	 * (a Group object)
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	...
	/**
	 * Removes a specific repetition of REF_I12_OBSERVATION
	 * (a Group object)
	 * @see AbstractGroup#insertremoveRepetition(String, int) 
	 */
	...
	public REF_I12_PATIENT_VISIT getPATIENT_VISIT() { 
	   ...
	   try {
	      ret = (REF_I12_PATIENT_VISIT)this.get("PATIENT_VISIT");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
