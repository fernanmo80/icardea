...
public class OUL_R23_RESULT extends AbstractGroup {
	...
	public OUL_R23_RESULT(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating OUL_R23_RESULT - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	/**
	 * Inserts a specific repetition of SID
	...
	/**
	 * Removes a specific repetition of SID
	 * (Substance Identifier)
