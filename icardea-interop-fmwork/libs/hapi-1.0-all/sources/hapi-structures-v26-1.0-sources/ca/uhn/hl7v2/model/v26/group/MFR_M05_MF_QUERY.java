 ...
 * 4: MFR_M05_MF_LOC_DEPT (a Group object) <b>repeating</b><br>
 */
public class MFR_M05_MF_QUERY extends AbstractGroup {
	...
	public MFR_M05_MF_QUERY(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      this.add(MFR_M05_MF_LOC_DEPT.class, true, true);
	...
	public MFR_M05_MF_LOC_DEPT getMF_LOC_DEPT() { 
	   ...
	   try {
	      ret = (MFR_M05_MF_LOC_DEPT)this.get("MF_LOC_DEPT");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public MFR_M05_MF_LOC_DEPT getMF_LOC_DEPT(int rep) throws HL7Exception { 
	   return (MFR_M05_MF_LOC_DEPT)this.get("MF_LOC_DEPT", rep);
	}
	...
	/**
	 * Inserts a specific repetition of MFR_M05_MF_LOC_DEPT
	 * (a Group object)
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	public void  insertMF_LOC_DEPT(MFR_M05_MF_LOC_DEPT structure, int rep) throws HL7Exception { 
	   super.insertRepetition( structure, rep);
	}
	 ...
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	public MFR_M05_MF_LOC_DEPT insertMF_LOC_DEPT(int rep) throws HL7Exception { 
	   return (MFR_M05_MF_LOC_DEPT)super.insertRepetition("MF_LOC_DEPT", rep);
	}

	/**
	 * Removes a specific repetition of MFR_M05_MF_LOC_DEPT
	 * (a Group object)
	 * @see AbstractGroup#insertremoveRepetition(String, int) 
	 */
	public MFR_M05_MF_LOC_DEPT removeMF_LOC_DEPT(int rep) throws HL7Exception { 
	   return (MFR_M05_MF_LOC_DEPT)super.removeRepetition("MF_LOC_DEPT", rep);
	}
