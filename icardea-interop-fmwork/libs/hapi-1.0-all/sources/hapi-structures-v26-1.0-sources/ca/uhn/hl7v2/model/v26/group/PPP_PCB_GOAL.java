...
public class PPP_PCB_GOAL extends AbstractGroup {
	...
	public PPP_PCB_GOAL(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      this.add(PPP_PCB_GOAL_ROLE.class, false, true);
	      this.add(PPP_PCB_GOAL_OBSERVATION.class, false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating PPP_PCB_GOAL - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public PPP_PCB_GOAL_ROLE getGOAL_ROLE() { 
	   ...
	   try {
	      ret = (PPP_PCB_GOAL_ROLE)this.get("GOAL_ROLE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public PPP_PCB_GOAL_ROLE getGOAL_ROLE(int rep) throws HL7Exception { 
	   return (PPP_PCB_GOAL_ROLE)this.get("GOAL_ROLE", rep);
	}
	...
	/**
	 * Inserts a specific repetition of PPP_PCB_GOAL_ROLE
	 * (a Group object)
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	...
	/**
	 * Removes a specific repetition of PPP_PCB_GOAL_ROLE
	 * (a Group object)
	 * @see AbstractGroup#insertremoveRepetition(String, int) 
	 */
	...
	public PPP_PCB_GOAL_OBSERVATION getGOAL_OBSERVATION() { 
	   ...
	   try {
	      ret = (PPP_PCB_GOAL_OBSERVATION)this.get("GOAL_OBSERVATION");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public PPP_PCB_GOAL_OBSERVATION getGOAL_OBSERVATION(int rep) throws HL7Exception { 
	   return (PPP_PCB_GOAL_OBSERVATION)this.get("GOAL_OBSERVATION", rep);
	}
	...
	/**
	 * Inserts a specific repetition of PPP_PCB_GOAL_OBSERVATION
	 * (a Group object)
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	...
	/**
	 * Removes a specific repetition of PPP_PCB_GOAL_OBSERVATION
	 * (a Group object)
	 * @see AbstractGroup#insertremoveRepetition(String, int) 
	 */
