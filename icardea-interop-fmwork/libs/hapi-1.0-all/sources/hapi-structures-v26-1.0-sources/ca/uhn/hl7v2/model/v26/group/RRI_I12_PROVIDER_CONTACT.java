...
public class RRI_I12_PROVIDER_CONTACT extends AbstractGroup {
	...
	public RRI_I12_PROVIDER_CONTACT(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating RRI_I12_PROVIDER_CONTACT - this is probably a bug in the source code generator.", e);
	   }
	}
