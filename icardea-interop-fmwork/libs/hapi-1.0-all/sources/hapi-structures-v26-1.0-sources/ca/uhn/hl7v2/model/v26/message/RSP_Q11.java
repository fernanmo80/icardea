 ...
 * 7: RSP_Q11_QUERY_RESULT_CLUSTER (a Group object) <b>optional </b><br>
...
public class RSP_Q11 extends AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating RSP_Q11 - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public RSP_Q11_QUERY_RESULT_CLUSTER getQUERY_RESULT_CLUSTER() { 
	   ...
	   try {
	      ret = (RSP_Q11_QUERY_RESULT_CLUSTER)this.get("QUERY_RESULT_CLUSTER");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
