...
public class PEX_P07_ASSOCIATED_RX_ORDER extends AbstractGroup {
	...
	public PEX_P07_ASSOCIATED_RX_ORDER(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      this.add(PEX_P07_NK1_TIMING_QTY.class, true, true);
	      this.add(RXR.class, false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating PEX_P07_ASSOCIATED_RX_ORDER - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public PEX_P07_NK1_TIMING_QTY getNK1_TIMING_QTY() { 
	   ...
	   try {
	      ret = (PEX_P07_NK1_TIMING_QTY)this.get("NK1_TIMING_QTY");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 */
	public PEX_P07_NK1_TIMING_QTY getNK1_TIMING_QTY(int rep) throws HL7Exception { 
	   return (PEX_P07_NK1_TIMING_QTY)this.get("NK1_TIMING_QTY", rep);
	}
	...
	/**
	 * Inserts a specific repetition of PEX_P07_NK1_TIMING_QTY
	 * (a Group object)
	...
	/**
	 * Removes a specific repetition of PEX_P07_NK1_TIMING_QTY
	 * (a Group object)
