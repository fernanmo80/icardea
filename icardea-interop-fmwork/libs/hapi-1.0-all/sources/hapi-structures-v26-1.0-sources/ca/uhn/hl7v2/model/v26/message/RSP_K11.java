 ...
 * 7: RSP_K11_ROW_DEFINITION (a Group object) <b>optional </b><br>
...
public class RSP_K11 extends AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating RSP_K11 - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public RSP_K11_ROW_DEFINITION getROW_DEFINITION() { 
	   ...
	   try {
	      ret = (RSP_K11_ROW_DEFINITION)this.get("ROW_DEFINITION");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
