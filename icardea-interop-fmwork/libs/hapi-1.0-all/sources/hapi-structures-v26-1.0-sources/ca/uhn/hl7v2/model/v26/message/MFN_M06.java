 ...
 * 4: MFN_M06_MF_CLIN_STUDY (a Group object) <b>repeating</b><br>
 */
public class MFN_M06 extends AbstractMessage  {
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public MFN_M06_MF_CLIN_STUDY getMF_CLIN_STUDY(int rep) throws HL7Exception { 
	   return (MFN_M06_MF_CLIN_STUDY)this.get("MF_CLIN_STUDY", rep);
	}
	...
	/**
	 * Inserts a specific repetition of MFN_M06_MF_CLIN_STUDY
	 * (a Group object)
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	...
	/**
	 * Removes a specific repetition of MFN_M06_MF_CLIN_STUDY
	 * (a Group object)
	 * @see AbstractGroup#insertremoveRepetition(String, int) 
	 */
