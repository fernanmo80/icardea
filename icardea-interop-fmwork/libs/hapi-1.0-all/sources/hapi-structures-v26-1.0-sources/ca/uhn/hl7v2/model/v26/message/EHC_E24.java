 ...
 * 6: EHC_E24_PSL_ITEM_INFO (a Group object) <b>repeating</b><br>
 */
public class EHC_E24 extends AbstractMessage  {

	/** 
	 * Creates a new EHC_E24 Group with custom ModelClassFactory.
	 */
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating EHC_E24 - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public EHC_E24_PSL_ITEM_INFO getPSL_ITEM_INFO() { 
	   ...
	   try {
	      ret = (EHC_E24_PSL_ITEM_INFO)this.get("PSL_ITEM_INFO");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public EHC_E24_PSL_ITEM_INFO getPSL_ITEM_INFO(int rep) throws HL7Exception { 
	   return (EHC_E24_PSL_ITEM_INFO)this.get("PSL_ITEM_INFO", rep);
	}
	...
	/**
	 * Inserts a specific repetition of EHC_E24_PSL_ITEM_INFO
	 * (a Group object)
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	...
	/**
	 * Removes a specific repetition of EHC_E24_PSL_ITEM_INFO
	 * (a Group object)
	 * @see AbstractGroup#insertremoveRepetition(String, int) 
	 */
