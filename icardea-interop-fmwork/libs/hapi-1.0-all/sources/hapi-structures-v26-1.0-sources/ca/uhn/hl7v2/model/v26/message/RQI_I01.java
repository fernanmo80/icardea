 ...
 * 3: RQI_I01_PROVIDER (a Group object) <b>repeating</b><br>
 * 4: PID (Patient Identification) <b></b><br>
 * 5: NK1 (Next of Kin / Associated Parties) <b>optional repeating</b><br>
 * 6: RQI_I01_GUARANTOR_INSURANCE (a Group object) <b>optional </b><br>
...
public class RQI_I01 extends AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating RQI_I01 - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public RQI_I01_PROVIDER getPROVIDER() { 
	   ...
	   try {
	      ret = (RQI_I01_PROVIDER)this.get("PROVIDER");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public RQI_I01_PROVIDER getPROVIDER(int rep) throws HL7Exception { 
	   return (RQI_I01_PROVIDER)this.get("PROVIDER", rep);
	}
	...
	/**
	 * Inserts a specific repetition of RQI_I01_PROVIDER
	 * (a Group object)
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	...
	/**
	 * Removes a specific repetition of RQI_I01_PROVIDER
	 * (a Group object)
	 * @see AbstractGroup#insertremoveRepetition(String, int) 
	 */
	...
	public RQI_I01_GUARANTOR_INSURANCE getGUARANTOR_INSURANCE() { 
	   ...
	   try {
	      ret = (RQI_I01_GUARANTOR_INSURANCE)this.get("GUARANTOR_INSURANCE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
