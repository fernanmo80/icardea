 ...
 * CSP-1: Study Phase Identifier (CWE)<br> 
 * CSP-2: Date/time Study Phase Began (DTM)<br> 
 * CSP-3: Date/time Study Phase Ended (DTM)<br> 
 * CSP-4: Study Phase Evaluability (CWE)<br> 
...
public class CSP extends AbstractSegment  {
  ...
  public CSP(Group parent, ModelClassFactory factory) {
    ...
    try {
       ...
       this.add(DTM.class, true, 1, 24, new Object[]{message}, "Date/time Study Phase Began");
       this.add(DTM.class, false, 1, 24, new Object[]{message}, "Date/time Study Phase Ended");
       this.add(CWE.class, false, 1, 705, new Object[]{message}, "Study Phase Evaluability");
