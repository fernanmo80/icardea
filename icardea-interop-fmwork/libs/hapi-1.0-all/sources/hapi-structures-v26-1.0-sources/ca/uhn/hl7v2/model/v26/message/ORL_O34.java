 ...
 * 6: ORL_O34_RESPONSE (a Group object) <b>optional </b><br>
 */
public class ORL_O34 extends AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating ORL_O34 - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public ORL_O34_RESPONSE getRESPONSE() { 
	   ...
	   try {
	      ret = (ORL_O34_RESPONSE)this.get("RESPONSE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
