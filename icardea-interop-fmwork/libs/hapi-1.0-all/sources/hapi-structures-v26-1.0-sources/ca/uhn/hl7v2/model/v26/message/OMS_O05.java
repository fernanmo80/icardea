 ...
 * 4: OMS_O05_PATIENT (a Group object) <b>optional </b><br>
 * 5: OMS_O05_ORDER (a Group object) <b>repeating</b><br>
 */
public class OMS_O05 extends AbstractMessage  {
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public OMS_O05_ORDER getORDER(int rep) throws HL7Exception { 
	   return (OMS_O05_ORDER)this.get("ORDER", rep);
	}
	...
	/**
	 * Inserts a specific repetition of OMS_O05_ORDER
	 * (a Group object)
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	...
	/**
	 * Removes a specific repetition of OMS_O05_ORDER
	 * (a Group object)
	 * @see AbstractGroup#insertremoveRepetition(String, int) 
	 */
