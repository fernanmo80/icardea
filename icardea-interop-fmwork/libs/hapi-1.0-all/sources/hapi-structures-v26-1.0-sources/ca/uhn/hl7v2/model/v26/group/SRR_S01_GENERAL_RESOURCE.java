...
public class SRR_S01_GENERAL_RESOURCE extends AbstractGroup {
	...
	public SRR_S01_GENERAL_RESOURCE(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating SRR_S01_GENERAL_RESOURCE - this is probably a bug in the source code generator.", e);
	   }
	}
