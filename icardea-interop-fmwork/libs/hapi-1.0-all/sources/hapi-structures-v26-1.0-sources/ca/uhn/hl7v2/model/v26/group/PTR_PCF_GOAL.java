...
public class PTR_PCF_GOAL extends AbstractGroup {
	...
	public PTR_PCF_GOAL(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating PTR_PCF_GOAL - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	/**
	 * Inserts a specific repetition of PTR_PCF_GOAL_ROLE
	 * (a Group object)
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	...
	/**
	 * Removes a specific repetition of PTR_PCF_GOAL_ROLE
	 * (a Group object)
	 * @see AbstractGroup#insertremoveRepetition(String, int) 
	 */
	...
	/**
	 * Inserts a specific repetition of PTR_PCF_GOAL_OBSERVATION
	 * (a Group object)
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	...
	/**
	 * Removes a specific repetition of PTR_PCF_GOAL_OBSERVATION
	 * (a Group object)
	 * @see AbstractGroup#insertremoveRepetition(String, int) 
	 */
