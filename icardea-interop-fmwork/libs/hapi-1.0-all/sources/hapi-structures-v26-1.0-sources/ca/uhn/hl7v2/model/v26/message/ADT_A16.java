 ...
 * 18: ADT_A16_PROCEDURE (a Group object) <b>optional repeating</b><br>
 * 19: GT1 (Guarantor) <b>optional repeating</b><br>
 * 20: ADT_A16_INSURANCE (a Group object) <b>optional repeating</b><br>
...
public class ADT_A16 extends AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating ADT_A16 - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public ADT_A16_PROCEDURE getPROCEDURE() { 
	   ...
	   try {
	      ret = (ADT_A16_PROCEDURE)this.get("PROCEDURE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public ADT_A16_PROCEDURE getPROCEDURE(int rep) throws HL7Exception { 
	   return (ADT_A16_PROCEDURE)this.get("PROCEDURE", rep);
	}
	...
	/**
	 * Inserts a specific repetition of ADT_A16_PROCEDURE
	 * (a Group object)
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	...
	/**
	 * Removes a specific repetition of ADT_A16_PROCEDURE
	 * (a Group object)
	 * @see AbstractGroup#insertremoveRepetition(String, int) 
	 */
	...
	public ADT_A16_INSURANCE getINSURANCE() { 
	   ...
	   try {
	      ret = (ADT_A16_INSURANCE)this.get("INSURANCE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public ADT_A16_INSURANCE getINSURANCE(int rep) throws HL7Exception { 
	   return (ADT_A16_INSURANCE)this.get("INSURANCE", rep);
	}
	...
	/**
	 * Inserts a specific repetition of ADT_A16_INSURANCE
	 * (a Group object)
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	...
	/**
	 * Removes a specific repetition of ADT_A16_INSURANCE
	 * (a Group object)
	 * @see AbstractGroup#insertremoveRepetition(String, int) 
	 */
