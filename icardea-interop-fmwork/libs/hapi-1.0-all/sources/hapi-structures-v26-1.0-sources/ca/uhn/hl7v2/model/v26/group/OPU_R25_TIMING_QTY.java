...
/**
 * <p>Represents the OPU_R25_TIMING_QTY Group.  A Group is an ordered collection of message 
 * segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements: </p>
 * 0: TQ1 (Timing/Quantity) <b></b><br>
 * 1: TQ2 (Timing/Quantity Relationship) <b>optional repeating</b><br>
 */
public class OPU_R25_TIMING_QTY extends AbstractGroup {

	/** 
	 * Creates a new OPU_R25_TIMING_QTY Group.
	 */
	public OPU_R25_TIMING_QTY(Group parent, ModelClassFactory factory) {
	   super(parent, factory);
	   try {
	      this.add(TQ1.class, true, false);
	      this.add(TQ2.class, false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating OPU_R25_TIMING_QTY - this is probably a bug in the source code generator.", e);
	   }
	}
