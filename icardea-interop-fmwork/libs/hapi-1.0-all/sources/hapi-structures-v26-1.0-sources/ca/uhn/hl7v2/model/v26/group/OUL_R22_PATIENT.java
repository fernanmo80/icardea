...
public class OUL_R22_PATIENT extends AbstractGroup {
	...
	public OUL_R22_PATIENT(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating OUL_R22_PATIENT - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public OUL_R22_VISIT getVISIT() { 
	   ...
	   try {
	      ret = (OUL_R22_VISIT)this.get("VISIT");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
