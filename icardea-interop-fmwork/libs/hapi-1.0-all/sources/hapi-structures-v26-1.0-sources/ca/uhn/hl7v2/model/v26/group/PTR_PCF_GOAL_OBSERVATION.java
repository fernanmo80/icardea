...
public class PTR_PCF_GOAL_OBSERVATION extends AbstractGroup {
	...
	public PTR_PCF_GOAL_OBSERVATION(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating PTR_PCF_GOAL_OBSERVATION - this is probably a bug in the source code generator.", e);
	   }
	}
