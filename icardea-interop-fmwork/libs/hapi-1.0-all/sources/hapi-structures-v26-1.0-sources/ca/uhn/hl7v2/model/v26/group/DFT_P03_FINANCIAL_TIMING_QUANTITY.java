...
public class DFT_P03_FINANCIAL_TIMING_QUANTITY extends AbstractGroup {
	...
	public DFT_P03_FINANCIAL_TIMING_QUANTITY(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating DFT_P03_FINANCIAL_TIMING_QUANTITY - this is probably a bug in the source code generator.", e);
	   }
	}
