...
public class CSU_C09_STUDY_PHARM extends AbstractGroup {
	 ...
	 */
	public CSU_C09_RX_ADMIN getRX_ADMIN(int rep) throws HL7Exception { 
	   return (CSU_C09_RX_ADMIN)this.get("RX_ADMIN", rep);
	}
	...
	/**
	 * Inserts a specific repetition of CSU_C09_RX_ADMIN
	 * (a Group object)
	...
	/**
	 * Removes a specific repetition of CSU_C09_RX_ADMIN
	 * (a Group object)
