...
public class OML_O35_PRIOR_RESULT extends AbstractGroup {
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public OML_O35_ORDER_PRIOR getORDER_PRIOR(int rep) throws HL7Exception { 
	   return (OML_O35_ORDER_PRIOR)this.get("ORDER_PRIOR", rep);
	}
	...
	/**
	 * Inserts a specific repetition of OML_O35_ORDER_PRIOR
	 * (a Group object)
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	...
	/**
	 * Removes a specific repetition of OML_O35_ORDER_PRIOR
	 * (a Group object)
	 * @see AbstractGroup#insertremoveRepetition(String, int) 
	 */
