...
public class ORU_R01_PATIENT_RESULT extends AbstractGroup {
	...
	public ORU_R01_PATIENT_RESULT(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating ORU_R01_PATIENT_RESULT - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	/**
	 * Inserts a specific repetition of ORU_R01_ORDER_OBSERVATION
	 * (a Group object)
	...
	/**
	 * Removes a specific repetition of ORU_R01_ORDER_OBSERVATION
	 * (a Group object)
