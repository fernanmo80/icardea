...
public class SQR_S25_PERSONNEL_RESOURCE extends AbstractGroup {
	...
	public SQR_S25_PERSONNEL_RESOURCE(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating SQR_S25_PERSONNEL_RESOURCE - this is probably a bug in the source code generator.", e);
	   }
	}
