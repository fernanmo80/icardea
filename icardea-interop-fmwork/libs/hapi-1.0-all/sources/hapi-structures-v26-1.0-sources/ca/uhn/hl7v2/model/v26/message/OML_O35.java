 ...
 * 4: OML_O35_PATIENT (a Group object) <b>optional </b><br>
 * 5: OML_O35_SPECIMEN (a Group object) <b>repeating</b><br>
 */
public class OML_O35 extends AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating OML_O35 - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public OML_O35_PATIENT getPATIENT() { 
	   ...
	   try {
	      ret = (OML_O35_PATIENT)this.get("PATIENT");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	...
	public OML_O35_SPECIMEN getSPECIMEN() { 
	   ...
	   try {
	      ret = (OML_O35_SPECIMEN)this.get("SPECIMEN");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public OML_O35_SPECIMEN getSPECIMEN(int rep) throws HL7Exception { 
	   return (OML_O35_SPECIMEN)this.get("SPECIMEN", rep);
	}
	...
	/**
	 * Inserts a specific repetition of OML_O35_SPECIMEN
	 * (a Group object)
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	...
	/**
	 * Removes a specific repetition of OML_O35_SPECIMEN
	 * (a Group object)
	 * @see AbstractGroup#insertremoveRepetition(String, int) 
	 */
