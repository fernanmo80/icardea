 ...
 * 6: ORL_O36_RESPONSE (a Group object) <b>optional </b><br>
 */
public class ORL_O36 extends AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating ORL_O36 - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public ORL_O36_RESPONSE getRESPONSE() { 
	   ...
	   try {
	      ret = (ORL_O36_RESPONSE)this.get("RESPONSE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
