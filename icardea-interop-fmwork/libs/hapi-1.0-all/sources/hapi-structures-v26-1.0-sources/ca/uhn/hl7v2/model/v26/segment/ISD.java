 ...
 * ISD-1: Reference Interaction Number (NM)<br> 
 * ISD-2: Interaction Type Identifier (CWE)<br> 
 * ISD-3: Interaction Active State (CWE)<br> 
...
public class ISD extends AbstractSegment  {
  ...
  public ISD(Group parent, ModelClassFactory factory) {
    ...
    try {
       this.add(NM.class, true, 1, 20, new Object[]{message}, "Reference Interaction Number");
       this.add(CWE.class, false, 1, 705, new Object[]{message}, "Interaction Type Identifier");
       this.add(CWE.class, true, 1, 705, new Object[]{message}, "Interaction Active State");
