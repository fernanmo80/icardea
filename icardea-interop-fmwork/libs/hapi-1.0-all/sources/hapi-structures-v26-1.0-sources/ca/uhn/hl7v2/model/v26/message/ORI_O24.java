 ...
 * 6: ORI_O24_RESPONSE (a Group object) <b>optional </b><br>
 */
public class ORI_O24 extends AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating ORI_O24 - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public ORI_O24_RESPONSE getRESPONSE() { 
	   ...
	   try {
	      ret = (ORI_O24_RESPONSE)this.get("RESPONSE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
