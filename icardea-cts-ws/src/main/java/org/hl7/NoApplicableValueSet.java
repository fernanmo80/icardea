 ...
 */
            ...
            /**
            *  NoApplicableValueSet bean class
            */
        
        public  class NoApplicableValueSet extends Exception
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = NoApplicableValueSet
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       NoApplicableValueSet.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":NoApplicableValueSet",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                                    ...
                                    if (localVocabularyDomain_name==null){
                                        ...
                                        if (! namespace2.equals("")) {
                                            ...
                                            if (prefix2 == null) {
                                                ...
                                                xmlWriter.writeStartElement(prefix2,"vocabularyDomain_name", namespace2);
                                                xmlWriter.writeNamespace(prefix2, namespace2);
                                                xmlWriter.setPrefix(prefix2, namespace2);

                                            } else {
                                                xmlWriter.writeStartElement(namespace2,"vocabularyDomain_name");
                                            }

                                        } else {
                                            xmlWriter.writeStartElement("vocabularyDomain_name");
                                        }
                                    ...
                                    if (localApplicationContext_code==null){
                                        ...
                                        if (! namespace2.equals("")) {
                                            ...
                                            if (prefix2 == null) {
                                                ...
                                                xmlWriter.writeStartElement(prefix2,"applicationContext_code", namespace2);
                                                xmlWriter.writeNamespace(prefix2, namespace2);
                                                xmlWriter.setPrefix(prefix2, namespace2);

                                            } else {
                                                xmlWriter.writeStartElement(namespace2,"applicationContext_code");
                                            }

                                        } else {
                                            xmlWriter.writeStartElement("applicationContext_code");
                                        }
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                            ...
                            elementList.add(new javax.xml.namespace.QName("urn://hl7.org/CTSMAPI",
                                    ...
                                    elementList.add(localVocabularyDomain_name==null?null:
                                    localVocabularyDomain_name);
                                
                            elementList.add(new javax.xml.namespace.QName("urn://hl7.org/CTSMAPI",
                                                                      "applicationContext_code"));
                            
                            
                                    elementList.add(localApplicationContext_code==null?null:
                                    localApplicationContext_code);
    ...
    public static class Factory{
        ...
        */
        public static NoApplicableValueSet parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            NoApplicableValueSet object =
                new NoApplicableValueSet();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"NoApplicableValueSet".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (NoApplicableValueSet)org.hl7.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("urn://hl7.org/CTSMAPI","vocabularyDomain_name").equals(reader.getName())){
                                      ...
                                      if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                          object.setVocabularyDomain_name(null);
                                          reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("urn://hl7.org/CTSMAPI","applicationContext_code").equals(reader.getName())){
                                      ...
                                      nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","nil");
                                      if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                          object.setApplicationContext_code(null);
                                          reader.next();
