...
public class SJM_TXTFilenameFilter implements FilenameFilter{
	/**
	 * Logger object
	 */
	@SuppressWarnings("unused")
	private static Logger logger = Logger.getLogger(SJM_TXTFilenameFilter.class);
	...
	public boolean accept(File dir, String name) {
		...
		if (name != null) {
			...
			if (name.equals("FollowupSummaryData.txt"))
			{
				returnCode = true;
			}
		}
