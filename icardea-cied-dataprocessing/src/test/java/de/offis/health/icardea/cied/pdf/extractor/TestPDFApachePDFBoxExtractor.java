...
/**
 * <p>
 * This class will test the Apache PDFBox v1.x based PDF extractor class {@link PDFApachePDFBoxExtractor}.
 * </p>
 * 
 *
 */
public class TestPDFApachePDFBoxExtractor {
	/**
	 * Logger object
	 */
	private static Logger logger = Logger.getLogger(TestPDFApachePDFBoxExtractor.class);
	...
	public void setUp() throws Exception {
		...
		if (pdfFileName == null) {
			...
			this.medtronicExtrFilePath = GlobalTools.checkDirectoryPath(medtronicPDFTestFileDirectory.getAbsolutePath()) + "extr_pdfbox";
			
			this.sjmExampleFiles = sjmPDFTestFileDirectory.listFiles(new PDFFilenameFilter());
			this.sjmExtrFilePath = GlobalTools.checkDirectoryPath(sjmPDFTestFileDirectory.getAbsolutePath()) + "extr_pdfbox";
		} else {
