...
/**
 * <p>
 * This class will test the iText v5+ based PDF extractor class {@link PDFiText5Extractor}.
 * </p>
 * 
 *
 */
public class TestPDFiText5Extractor {
	/**
	 * Logger object
	 */
	private static Logger logger = Logger.getLogger(TestPDFiText5Extractor.class);
	...
	public void setUp() throws Exception {
		...
		if (pdfFileName == null) {
			...
			this.medtronicExtrFilePath = GlobalTools.checkDirectoryPath(medtronicPDFTestFileDirectory.getAbsolutePath()) + "extr_iText5";
			
			this.sjmExampleFiles = sjmPDFTestFileDirectory.listFiles(new PDFFilenameFilter());
			this.sjmExtrFilePath = GlobalTools.checkDirectoryPath(sjmPDFTestFileDirectory.getAbsolutePath()) + "extr_iText5";
		} else {
	...
	public void openPDFFilesSuccess() throws IOException, Exception {
		...
		try {
			...
			for (int i = 0; i < this.medtronicExampleFiles.length; i++) {
				pdfExtractor = new PDFiText5Extractor();
