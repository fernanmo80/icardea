...
/**
 * <p>Java class for NoApplicableDesignationFound complex type.
 * 
...
@XmlType(name = "NoApplicableDesignationFound", propOrder = {
    "codeToFillIn",
    "displayLanguageCode"
})
public class NoApplicableDesignationFound {

    @XmlElement(required = true, nillable = true)
    protected CD codeToFillIn;
    @XmlElement(name = "displayLanguage_code", required = true, nillable = true)
