<MedicalCareplan name="Technical Careplan" ID="TechnicalCareplan" version="2.0" xsi:noNamespaceSchemaLocation="Careplan.xsd" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
  <Header>
