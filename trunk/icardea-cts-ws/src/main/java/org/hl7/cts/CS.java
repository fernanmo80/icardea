...
public class CS implements org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name = CS
	 ...
	 * @return java.lang.String
	 */
	public java.lang.String getCodingRationale() {
	 ...
	 *            CodingRationale
	 */
	public void setCodingRationale(java.lang.String param) {
	...
	public org.apache.axiom.om.OMElement getOMElement(
		...
		org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(
			...
			public void serialize(
				...
				CS.this.serialize(parentQName, factory, xmlWriter);
			}
		};
	...
	public void serialize(
		...
		if (!namespace.equals("")) {
			...
			if (prefix == null) {
				...
				xmlWriter.writeStartElement(prefix, "codingRationale",
						namespace);
				xmlWriter.writeNamespace(prefix, namespace);
				xmlWriter.setPrefix(prefix, namespace);

			} else {
				xmlWriter.writeStartElement(namespace, "codingRationale");
			}
	...
	public javax.xml.stream.XMLStreamReader getPullParser(
		...
		elementList.add(localCodingRationale == null ? null
				: org.apache.axis2.databinding.utils.ConverterUtil
						.convertToString(localCodingRationale));
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static CS parse(javax.xml.stream.XMLStreamReader reader)
			...
			try {
						...
						if (!"CS".equals(type)) {
							...
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (CS) org.hl7.ExtensionMapper.getTypeObject(
									nsUri, type, reader);
						}
				...
				if (reader.isStartElement()
					...
					if (!"true".equals(nillableValue)
						...
						object
								.setCodingRationale(org.apache.axis2.databinding.utils.ConverterUtil
										.convertToString(content));
