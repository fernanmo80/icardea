<Body>
	...
	<NextStep ref="S42F61D34-3D6A-29F5-D8FD-67B19FD9CE09"/>
      ...
      <ConsultStep ID="SDB90A900-17C5-021C-3979-67BE0CE1D4A7"   name="Present Medications Compliance">
	  ...
	  <HTML>
		...
		<tbody>
		  ...
		  <tr name="ChoiceBlock">
			...
			<input type="submit" name="F6Choice" value="There is medication incompliance" onclick="btnWhichButton=this"/>
		      </form>
		    </td>
		  </tr>
		</tbody>
	...
	<NextStep ref="S4105C271-9A29-9749-DF2F-67CDEBA6879B" name="There is medication incompliance">
	  <EvaluationScript>function check(SDB90A90017C5021C397967BE0CE1D4A7Choice) { if(SDB90A90017C5021C397967BE0CE1D4A7Choice.getValue().getText() == "There is medication incompliance") return true; else return false; }</EvaluationScript>
	</NextStep>
	<NextStep ref="SA3C434EA-7528-8DF6-B0C4-67CDDE4882FA" name="There is no medication incompliance">
      ...
      <ConsultStep ID="SA3C434EA-7528-8DF6-B0C4-67CDDE4882FA" name="Present Medications Change">
	<Variable name="MedicationsEHR" type="String[]">
	  <DataSource code="C2362543" name="Electronic Health Records" schemeID="UMLS"/>
	  <DataSource code="C2598133" name="Medication" schemeID="UMLS"/>
	</Variable>
		...
		<tbody>
		  ...
		  <tr name="ChoiceBlock">
		    <td style="background-color:#eeeeee"><p align="center"><b><font color="#880015">Recommendation
		      ...
		      <p>Please select the appropriate case: </p>
		      <form onsubmit="return ValidateData();" action="null" method="post">
			<input type="submit" name="S62Choice" value="There is medication change" onclick="btnWhichButton=this"/>
			<input type="submit" name="S62Choice" value="There is no medication change" onclick="btnWhichButton=this" />
		      </form>
		    </td>
		  </tr>
		</tbody>
	...
	<NextStep ref="S2742F174-2A18-DA5C-07B8-680FFD3A2E78" name="There is medication change">
	  <EvaluationScript>function check(SA3C434EA75288DF6B0C467CDDE4882FAChoice) { if(SA3C434EA75288DF6B0C467CDDE4882FAChoice.getValue().getText() == "There is medication change") return true; else return false; }</EvaluationScript>
	</NextStep>
	<NextStep ref="S3020C9A9-10AC-0EB5-EEAC-680FDC81033E" name="There is no medication change">
	  <EvaluationScript>function check(SA3C434EA75288DF6B0C467CDDE4882FAChoice) { if(SA3C434EA75288DF6B0C467CDDE4882FAChoice.getValue().getText() == "There is no medication change") return true; else return false; }</EvaluationScript>
	</NextStep>
      </ConsultStep>
	...
	<HTML>
      ...
      <RecommendationStep ID="S2742F174-2A18-DA5C-07B8-680FFD3A2E78" name="Take Corrective Action about Medication change">
      <Receiver ref="P3"/>
      <Urgency>2</Urgency>
      <Display>
	<HTML>
	  ...
	  <body>
		...
		<tr name="RecommendationBlock">
		  <td style="background-color:#eeeeee">
		    <p align="center"><b><font color="#880015">Recommendation and Next Step to follow </font> </b></p>
		    <p>Based on the data retrieved from the PHR, Medication change has been observed, this could be the underlying reason for the CIED Alert, Please take the corrective action.</p>
