...
class AggregateDragControl extends ControlAdapter {
     ...
     * is dragged.
     */
    public AggregateDragControl(GuidelineGraph guidelineGraph) {
    ...
    public void itemEntered(VisualItem item, MouseEvent e) {
        ...
        if (item.canGetString(GuidelineGraph.TOOLTIP)) {
            d.setToolTipText(item.getString(GuidelineGraph.TOOLTIP));
        }
