...
public class FORTHListener {
	...
	private static String CreateSoapEnv(String template_path,String boundary_uuid,String cda_content){
		...
		try{
			...
			tmp=tmp.replace("BASE64_DOCUMENT", new String(org.apache.commons.codec.binary.Base64.encodeBase64(cda_content.getBytes())));
			...
			tmp = tmp.replaceAll("SUBMISSION_SET_UNIQUE_ID", GetUUID());
	...
	public static String Provide_Register(String doc_id,String cda_content){
	...
	/*public static void main(String[] args){
		try{
			String res="";
			String xds_url="https://icardea-server.lksdom21.lks.local/ehrif/xds/";
			String cda_path="EPSOS-CDA-Document.xml";
