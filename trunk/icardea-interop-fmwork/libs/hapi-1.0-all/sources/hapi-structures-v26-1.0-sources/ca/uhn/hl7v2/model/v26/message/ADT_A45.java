 ...
 * 6: ADT_A45_MERGE_INFO (a Group object) <b>repeating</b><br>
 */
public class ADT_A45 extends AbstractMessage  {
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public ADT_A45_MERGE_INFO getMERGE_INFO(int rep) throws HL7Exception { 
	   return (ADT_A45_MERGE_INFO)this.get("MERGE_INFO", rep);
	}
	...
	/**
	 * Inserts a specific repetition of ADT_A45_MERGE_INFO
	 * (a Group object)
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	...
	/**
	 * Removes a specific repetition of ADT_A45_MERGE_INFO
	 * (a Group object)
	 * @see AbstractGroup#insertremoveRepetition(String, int) 
	 */
