...
public class SDR_S32 extends AbstractMessage  {
	...
	/** 
	 * Creates a new SDR_S32 Group with custom ModelClassFactory.
	 */
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating SDR_S32 - this is probably a bug in the source code generator.", e);
	   }
	}
