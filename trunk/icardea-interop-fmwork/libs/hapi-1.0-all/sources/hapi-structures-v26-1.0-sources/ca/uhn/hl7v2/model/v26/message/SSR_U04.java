 ...
 * 4: SSR_U04_SPECIMEN_CONTAINER (a Group object) <b>repeating</b><br>
...
public class SSR_U04 extends AbstractMessage  {
	...
	public SSR_U04_SPECIMEN_CONTAINER getSPECIMEN_CONTAINER() { 
	   ...
	   try {
	      ret = (SSR_U04_SPECIMEN_CONTAINER)this.get("SPECIMEN_CONTAINER");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public SSR_U04_SPECIMEN_CONTAINER getSPECIMEN_CONTAINER(int rep) throws HL7Exception { 
	   return (SSR_U04_SPECIMEN_CONTAINER)this.get("SPECIMEN_CONTAINER", rep);
	}
	...
	/**
	 * Inserts a specific repetition of SSR_U04_SPECIMEN_CONTAINER
	 * (a Group object)
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	...
	/**
	 * Removes a specific repetition of SSR_U04_SPECIMEN_CONTAINER
	 * (a Group object)
	 * @see AbstractGroup#insertremoveRepetition(String, int) 
	 */
