...
public class OUL_R24_PATIENT extends AbstractGroup {
	...
	public OUL_R24_PATIENT(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating OUL_R24_PATIENT - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public OUL_R24_VISIT getVISIT() { 
	   ...
	   try {
	      ret = (OUL_R24_VISIT)this.get("VISIT");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
