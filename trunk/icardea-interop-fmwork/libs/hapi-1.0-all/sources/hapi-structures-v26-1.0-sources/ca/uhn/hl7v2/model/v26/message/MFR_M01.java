 ...
 * 9: MFR_M01_MF_QUERY (a Group object) <b>repeating</b><br>
...
public class MFR_M01 extends AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating MFR_M01 - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public MFR_M01_MF_QUERY getMF_QUERY() { 
	   ...
	   try {
	      ret = (MFR_M01_MF_QUERY)this.get("MF_QUERY");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public MFR_M01_MF_QUERY getMF_QUERY(int rep) throws HL7Exception { 
	   return (MFR_M01_MF_QUERY)this.get("MF_QUERY", rep);
	}
	...
	/**
	 * Inserts a specific repetition of MFR_M01_MF_QUERY
	 * (a Group object)
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	...
	/**
	 * Removes a specific repetition of MFR_M01_MF_QUERY
	 * (a Group object)
	 * @see AbstractGroup#insertremoveRepetition(String, int) 
	 */
