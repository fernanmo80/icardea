...
public class RGV_O15_ORDER extends AbstractGroup {
	...
	/**
	 * Inserts a specific repetition of RGV_O15_TIMING
	 * (a Group object)
	...
	/**
	 * Removes a specific repetition of RGV_O15_TIMING
	 * (a Group object)
	...
	/**
	 * Inserts a specific repetition of RGV_O15_GIVE
	 * (a Group object)
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	...
	/**
	 * Removes a specific repetition of RGV_O15_GIVE
	 * (a Group object)
	 * @see AbstractGroup#insertremoveRepetition(String, int) 
	 */
