...
public class PPP_PCB_PROBLEM extends AbstractGroup {
	...
	/**
	 * Inserts a specific repetition of PPP_PCB_PROBLEM_ROLE
	 * (a Group object)
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	...
	/**
	 * Removes a specific repetition of PPP_PCB_PROBLEM_ROLE
	 * (a Group object)
	 * @see AbstractGroup#insertremoveRepetition(String, int) 
	 */
	...
	/**
	 * Inserts a specific repetition of PPP_PCB_PROBLEM_OBSERVATION
	 * (a Group object)
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	...
	/**
	 * Removes a specific repetition of PPP_PCB_PROBLEM_OBSERVATION
	 * (a Group object)
	 * @see AbstractGroup#insertremoveRepetition(String, int) 
	 */
	...
	/**
	 * Inserts a specific repetition of PPP_PCB_GOAL
	 * (a Group object)
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	...
	/**
	 * Removes a specific repetition of PPP_PCB_GOAL
	 * (a Group object)
	 * @see AbstractGroup#insertremoveRepetition(String, int) 
	 */
	...
	/**
	 * Inserts a specific repetition of PPP_PCB_ORDER
	 * (a Group object)
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	...
	/**
	 * Removes a specific repetition of PPP_PCB_ORDER
	 * (a Group object)
	 * @see AbstractGroup#insertremoveRepetition(String, int) 
	 */
