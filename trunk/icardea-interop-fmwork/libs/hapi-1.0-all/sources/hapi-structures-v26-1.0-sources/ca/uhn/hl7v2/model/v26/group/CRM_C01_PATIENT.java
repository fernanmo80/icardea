...
public class CRM_C01_PATIENT extends AbstractGroup {
	...
	public CRM_C01_PATIENT(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating CRM_C01_PATIENT - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	/**
	 * Inserts a specific repetition of CSP
	...
	/**
	 * Removes a specific repetition of CSP
	 * (Clinical Study Phase)
