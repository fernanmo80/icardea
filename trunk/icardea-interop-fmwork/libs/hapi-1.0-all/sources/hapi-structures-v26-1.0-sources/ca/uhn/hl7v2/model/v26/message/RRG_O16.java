 ...
 * 6: RRG_O16_RESPONSE (a Group object) <b>optional </b><br>
 */
public class RRG_O16 extends AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating RRG_O16 - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public RRG_O16_RESPONSE getRESPONSE() { 
	   ...
	   try {
	      ret = (RRG_O16_RESPONSE)this.get("RESPONSE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
