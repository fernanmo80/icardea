...
public class RGV_O15_ENCODING extends AbstractGroup {
	...
	public RGV_O15_ENCODING(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      this.add(RGV_O15_TIMING_ENCODED.class, true, true);
	      this.add(RXR.class, true, true);
	      this.add(RXC.class, false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating RGV_O15_ENCODING - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public RGV_O15_TIMING_ENCODED getTIMING_ENCODED() { 
	   ...
	   try {
	      ret = (RGV_O15_TIMING_ENCODED)this.get("TIMING_ENCODED");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 */
	public RGV_O15_TIMING_ENCODED getTIMING_ENCODED(int rep) throws HL7Exception { 
	   return (RGV_O15_TIMING_ENCODED)this.get("TIMING_ENCODED", rep);
	}
	...
	/**
	 * Inserts a specific repetition of RGV_O15_TIMING_ENCODED
	 * (a Group object)
	...
	/**
	 * Removes a specific repetition of RGV_O15_TIMING_ENCODED
	 * (a Group object)
