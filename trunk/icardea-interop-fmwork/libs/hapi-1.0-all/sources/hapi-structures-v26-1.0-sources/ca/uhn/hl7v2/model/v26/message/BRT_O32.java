 ...
 * 6: BRT_O32_RESPONSE (a Group object) <b>optional </b><br>
 */
public class BRT_O32 extends AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating BRT_O32 - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public BRT_O32_RESPONSE getRESPONSE() { 
	   ...
	   try {
	      ret = (BRT_O32_RESPONSE)this.get("RESPONSE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
