 ...
 * 4: RAS_O17_PATIENT (a Group object) <b>optional </b><br>
 * 5: RAS_O17_ORDER (a Group object) <b>repeating</b><br>
 */
public class RAS_O17 extends AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating RAS_O17 - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public RAS_O17_PATIENT getPATIENT() { 
	   ...
	   try {
	      ret = (RAS_O17_PATIENT)this.get("PATIENT");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	...
	public RAS_O17_ORDER getORDER() { 
	   ...
	   try {
	      ret = (RAS_O17_ORDER)this.get("ORDER");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public RAS_O17_ORDER getORDER(int rep) throws HL7Exception { 
	   return (RAS_O17_ORDER)this.get("ORDER", rep);
	}
	...
	/**
	 * Inserts a specific repetition of RAS_O17_ORDER
	 * (a Group object)
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	...
	/**
	 * Removes a specific repetition of RAS_O17_ORDER
	 * (a Group object)
	 * @see AbstractGroup#insertremoveRepetition(String, int) 
	 */
