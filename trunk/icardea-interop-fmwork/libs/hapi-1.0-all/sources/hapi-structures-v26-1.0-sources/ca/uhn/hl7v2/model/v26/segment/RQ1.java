 ...
 * RQ1-2: Manufacturer Identifier (CWE)<br> 
 * RQ1-3: Manufacturer's Catalog (ST)<br> 
 * RQ1-4: Vendor ID (CWE)<br> 
...
public class RQ1 extends AbstractSegment  {
  ...
  public RQ1(Group parent, ModelClassFactory factory) {
    ...
    try {
       this.add(ST.class, false, 1, 10, new Object[]{message}, "Anticipated Price");
       this.add(CWE.class, false, 1, 705, new Object[]{message}, "Manufacturer Identifier");
       this.add(ST.class, false, 1, 16, new Object[]{message}, "Manufacturer's Catalog");
       this.add(CWE.class, false, 1, 250, new Object[]{message}, "Vendor ID");
       this.add(ST.class, false, 1, 16, new Object[]{message}, "Vendor Catalog");
       this.add(ID.class, false, 1, 1, new Object[]{message, new Integer(136)}, "Taxable");
       this.add(ID.class, false, 1, 1, new Object[]{message, new Integer(136)}, "Substitute Allowed");
