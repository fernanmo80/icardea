 ...
 * 7: PRR_PC5_PATIENT (a Group object) <b>repeating</b><br>
 */
public class PRR_PC5 extends AbstractMessage  {
	...
	public PRR_PC5_PATIENT getPATIENT() { 
	   ...
	   try {
	      ret = (PRR_PC5_PATIENT)this.get("PATIENT");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public PRR_PC5_PATIENT getPATIENT(int rep) throws HL7Exception { 
	   return (PRR_PC5_PATIENT)this.get("PATIENT", rep);
	}
	...
	/**
	 * Inserts a specific repetition of PRR_PC5_PATIENT
	 * (a Group object)
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	...
	/**
	 * Removes a specific repetition of PRR_PC5_PATIENT
	 * (a Group object)
	 * @see AbstractGroup#insertremoveRepetition(String, int) 
	 */
