 ...
 * 6: VXX_V02_PATIENT (a Group object) <b>repeating</b><br>
 */
public class VXX_V02 extends AbstractMessage  {
	...
	public VXX_V02_PATIENT getPATIENT() { 
	   ...
	   try {
	      ret = (VXX_V02_PATIENT)this.get("PATIENT");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public VXX_V02_PATIENT getPATIENT(int rep) throws HL7Exception { 
	   return (VXX_V02_PATIENT)this.get("PATIENT", rep);
	}
	...
	/**
	 * Inserts a specific repetition of VXX_V02_PATIENT
	 * (a Group object)
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	...
	/**
	 * Removes a specific repetition of VXX_V02_PATIENT
	 * (a Group object)
	 * @see AbstractGroup#insertremoveRepetition(String, int) 
	 */
