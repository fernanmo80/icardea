...
public class OML_O21_PATIENT extends AbstractGroup {
	...
	public OML_O21_PATIENT(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      this.add(OML_O21_PATIENT_VISIT.class, false, false);
	      this.add(OML_O21_INSURANCE.class, false, true);
	      this.add(GT1.class, false, false);
	      this.add(AL1.class, false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating OML_O21_PATIENT - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public OML_O21_PATIENT_VISIT getPATIENT_VISIT() { 
	   ...
	   try {
	      ret = (OML_O21_PATIENT_VISIT)this.get("PATIENT_VISIT");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	...
	public OML_O21_INSURANCE getINSURANCE() { 
	   ...
	   try {
	      ret = (OML_O21_INSURANCE)this.get("INSURANCE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public OML_O21_INSURANCE getINSURANCE(int rep) throws HL7Exception { 
	   return (OML_O21_INSURANCE)this.get("INSURANCE", rep);
	}
	...
	/**
	 * Inserts a specific repetition of OML_O21_INSURANCE
	 * (a Group object)
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	...
	/**
	 * Removes a specific repetition of OML_O21_INSURANCE
	 * (a Group object)
	 * @see AbstractGroup#insertremoveRepetition(String, int) 
	 */
