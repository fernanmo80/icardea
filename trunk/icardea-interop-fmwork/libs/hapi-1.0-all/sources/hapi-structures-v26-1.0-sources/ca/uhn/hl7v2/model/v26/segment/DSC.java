...
public class DSC extends AbstractSegment  {
  ...
  public DSC(Group parent, ModelClassFactory factory) {
    ...
    try {
       ...
       this.add(ID.class, false, 1, 1, new Object[]{message, new Integer(398)}, "Continuation Style");
  ...
  public ID getDsc2_ContinuationStyle()  {
   ...
   protected Type createNewTypeWithoutReflection(int field) {
      switch (field) {
         ...
         case 1: return new ca.uhn.hl7v2.model.v26.datatype.ID(getMessage(), new Integer(398));
         default: return null;
      }
   }
