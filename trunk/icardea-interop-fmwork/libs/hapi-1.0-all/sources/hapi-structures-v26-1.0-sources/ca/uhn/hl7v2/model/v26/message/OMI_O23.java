 ...
 * 4: OMI_O23_PATIENT (a Group object) <b>optional </b><br>
 * 5: OMI_O23_ORDER (a Group object) <b>repeating</b><br>
 */
public class OMI_O23 extends AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating OMI_O23 - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public OMI_O23_PATIENT getPATIENT() { 
	   ...
	   try {
	      ret = (OMI_O23_PATIENT)this.get("PATIENT");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	...
	public OMI_O23_ORDER getORDER() { 
	   ...
	   try {
	      ret = (OMI_O23_ORDER)this.get("ORDER");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public OMI_O23_ORDER getORDER(int rep) throws HL7Exception { 
	   return (OMI_O23_ORDER)this.get("ORDER", rep);
	}
	...
	/**
	 * Inserts a specific repetition of OMI_O23_ORDER
	 * (a Group object)
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	...
	/**
	 * Removes a specific repetition of OMI_O23_ORDER
	 * (a Group object)
	 * @see AbstractGroup#insertremoveRepetition(String, int) 
	 */
