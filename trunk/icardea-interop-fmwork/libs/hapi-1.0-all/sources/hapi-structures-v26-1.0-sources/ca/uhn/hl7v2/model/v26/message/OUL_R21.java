...
public class OUL_R21 extends AbstractMessage  {
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public OUL_R21_ORDER_OBSERVATION getORDER_OBSERVATION(int rep) throws HL7Exception { 
	   return (OUL_R21_ORDER_OBSERVATION)this.get("ORDER_OBSERVATION", rep);
	}
	...
	/**
	 * Inserts a specific repetition of OUL_R21_ORDER_OBSERVATION
	 * (a Group object)
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	...
	/**
	 * Removes a specific repetition of OUL_R21_ORDER_OBSERVATION
	 * (a Group object)
	 * @see AbstractGroup#insertremoveRepetition(String, int) 
	 */
