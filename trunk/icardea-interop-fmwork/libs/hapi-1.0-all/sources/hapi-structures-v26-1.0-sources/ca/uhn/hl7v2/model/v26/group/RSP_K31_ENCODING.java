...
public class RSP_K31_ENCODING extends AbstractGroup {
	...
	public RSP_K31_ENCODING(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      this.add(RSP_K31_TIMING_ENCODED.class, true, true);
	      this.add(RXR.class, true, true);
	      this.add(RXC.class, false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating RSP_K31_ENCODING - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public RSP_K31_TIMING_ENCODED getTIMING_ENCODED() { 
	   ...
	   try {
	      ret = (RSP_K31_TIMING_ENCODED)this.get("TIMING_ENCODED");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 */
	public RSP_K31_TIMING_ENCODED getTIMING_ENCODED(int rep) throws HL7Exception { 
	   return (RSP_K31_TIMING_ENCODED)this.get("TIMING_ENCODED", rep);
	}
	...
	/**
	 * Inserts a specific repetition of RSP_K31_TIMING_ENCODED
	 * (a Group object)
	...
	/**
	 * Removes a specific repetition of RSP_K31_TIMING_ENCODED
	 * (a Group object)
