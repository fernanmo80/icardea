 ...
 * 4: MFE (Master File Entry) <b>repeating</b><br>
 */
public class MFN_M13 extends AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating MFN_M13 - this is probably a bug in the source code generator.", e);
	   }
	}
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public MFE getMFE(int rep) throws HL7Exception { 
	   return (MFE)this.get("MFE", rep);
	}
	...
	/**
	 * Inserts a specific repetition of MFE
	 * (Master File Entry)
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	...
	/**
	 * Removes a specific repetition of MFE
	 * (Master File Entry)
	 * @see AbstractGroup#insertremoveRepetition(String, int) 
	 */
