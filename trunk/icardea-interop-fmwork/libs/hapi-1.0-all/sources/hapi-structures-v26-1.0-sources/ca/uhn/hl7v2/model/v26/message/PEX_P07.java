 ...
 * 7: PEX_P07_VISIT (a Group object) <b>optional </b><br>
 * 8: PEX_P07_EXPERIENCE (a Group object) <b>repeating</b><br>
 */
public class PEX_P07 extends AbstractMessage  {
	...
	public PEX_P07_VISIT getVISIT() { 
	   ...
	   try {
	      ret = (PEX_P07_VISIT)this.get("VISIT");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	...
	public PEX_P07_EXPERIENCE getEXPERIENCE() { 
	   ...
	   try {
	      ret = (PEX_P07_EXPERIENCE)this.get("EXPERIENCE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public PEX_P07_EXPERIENCE getEXPERIENCE(int rep) throws HL7Exception { 
	   return (PEX_P07_EXPERIENCE)this.get("EXPERIENCE", rep);
	}
	...
	/**
	 * Inserts a specific repetition of PEX_P07_EXPERIENCE
	 * (a Group object)
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	...
	/**
	 * Removes a specific repetition of PEX_P07_EXPERIENCE
	 * (a Group object)
	 * @see AbstractGroup#insertremoveRepetition(String, int) 
	 */
