...
/**
 * <p>Represents the OML_O33_TIMING Group.  A Group is an ordered collection of message 
...
public class OML_O33_TIMING extends AbstractGroup {
	...
	public OML_O33_TIMING(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating OML_O33_TIMING - this is probably a bug in the source code generator.", e);
	   }
	}
