...
public class OML_O35_ORDER extends AbstractGroup {
	...
	public OML_O35_ORDER(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      this.add(OML_O35_TIIMING.class, false, true);
	      this.add(OML_O35_OBSERVATION_REQUEST.class, false, false);
	      this.add(FT1.class, false, true);
	      this.add(CTI.class, false, true);
	      this.add(BLG.class, false, false);
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating OML_O35_ORDER - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public OML_O35_TIIMING getTIIMING() { 
	   ...
	   try {
	      ret = (OML_O35_TIIMING)this.get("TIIMING");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 */
	public OML_O35_TIIMING getTIIMING(int rep) throws HL7Exception { 
	   return (OML_O35_TIIMING)this.get("TIIMING", rep);
	}

	/** 
	 * Returns the number of existing repetitions of OML_O35_TIIMING 
	 */ 
	public int getTIIMINGReps() { 
	    int reps = -1; 
	    try { 
	...
	/**
	 * Inserts a specific repetition of OML_O35_TIIMING
	 * (a Group object)
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	public void  insertTIIMING(OML_O35_TIIMING structure, int rep) throws HL7Exception { 
	 ...
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	public OML_O35_TIIMING insertTIIMING(int rep) throws HL7Exception { 
	   return (OML_O35_TIIMING)super.insertRepetition("TIIMING", rep);
	}

	/**
	 * Removes a specific repetition of OML_O35_TIIMING
	 * (a Group object)
	 * @see AbstractGroup#insertremoveRepetition(String, int) 
	 */
	public OML_O35_TIIMING removeTIIMING(int rep) throws HL7Exception { 
	   return (OML_O35_TIIMING)super.removeRepetition("TIIMING", rep);
	}
	...
	public OML_O35_OBSERVATION_REQUEST getOBSERVATION_REQUEST() { 
	   ...
	   try {
	      ret = (OML_O35_OBSERVATION_REQUEST)this.get("OBSERVATION_REQUEST");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
