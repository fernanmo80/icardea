...
/**
 * <p>Represents an HL7 STZ message segment. 
 * This segment has the following fields:</p><p>
 * STZ-1: Sterilization Type (CWE)<br> 
 * STZ-2: Sterilization Cycle (CWE)<br> 
 * STZ-3: Maintenance Cycle (CWE)<br> 
 * STZ-4: Maintenance Type (CWE)<br> 
...
public class STZ extends AbstractSegment  {
  ...
  public STZ(Group parent, ModelClassFactory factory) {
    ...
    try {
       this.add(CWE.class, false, 1, 250, new Object[]{message}, "Sterilization Type");
       this.add(CWE.class, false, 1, 250, new Object[]{message}, "Sterilization Cycle");
       this.add(CWE.class, false, 1, 250, new Object[]{message}, "Maintenance Cycle");
       this.add(CWE.class, false, 1, 250, new Object[]{message}, "Maintenance Type");
