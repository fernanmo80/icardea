 ...
 * EQU-2: Event Date/Time (DTM)<br> 
 * EQU-3: Equipment State (CWE)<br> 
 * EQU-4: Local/Remote Control State (CWE)<br> 
 * EQU-5: Alert Level (CWE)<br> 
...
public class EQU extends AbstractSegment  {
  ...
  public EQU(Group parent, ModelClassFactory factory) {
    ...
    try {
       this.add(EI.class, true, 1, 427, new Object[]{message}, "Equipment Instance Identifier");
       this.add(DTM.class, true, 1, 24, new Object[]{message}, "Event Date/Time");
       this.add(CWE.class, false, 1, 705, new Object[]{message}, "Equipment State");
       this.add(CWE.class, false, 1, 705, new Object[]{message}, "Local/Remote Control State");
       this.add(CWE.class, false, 1, 705, new Object[]{message}, "Alert Level");
