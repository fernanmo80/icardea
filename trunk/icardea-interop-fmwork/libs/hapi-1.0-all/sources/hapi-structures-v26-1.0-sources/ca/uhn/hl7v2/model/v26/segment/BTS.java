...
public class BTS extends AbstractSegment  {
  ...
  /**
   * Returns a count of the number of repetitions of Batch Totals (BTS-3).
   */
  ...
  /**
   * Inserts a repetition of Batch Totals (BTS-3) at a given index and returns it.
  ...
  /**
   * Removes a repetition of Batch Totals (BTS-3) at a given index and returns it.
   * @param index The index
   */
