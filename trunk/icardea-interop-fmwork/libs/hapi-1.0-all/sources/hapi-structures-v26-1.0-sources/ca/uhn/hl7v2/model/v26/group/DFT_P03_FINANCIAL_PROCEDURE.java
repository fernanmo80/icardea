...
public class DFT_P03_FINANCIAL_PROCEDURE extends AbstractGroup {
	...
	public DFT_P03_FINANCIAL_PROCEDURE(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating DFT_P03_FINANCIAL_PROCEDURE - this is probably a bug in the source code generator.", e);
	   }
	}
