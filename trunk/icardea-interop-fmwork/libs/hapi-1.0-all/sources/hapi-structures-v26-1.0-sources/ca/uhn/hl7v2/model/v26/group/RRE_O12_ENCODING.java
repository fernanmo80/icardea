...
public class RRE_O12_ENCODING extends AbstractGroup {
	...
	public RRE_O12_ENCODING(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      this.add(RRE_O12_TIMING_ENCODED.class, true, true);
	      this.add(RXR.class, true, true);
	      this.add(RXC.class, false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating RRE_O12_ENCODING - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public RRE_O12_TIMING_ENCODED getTIMING_ENCODED() { 
	   ...
	   try {
	      ret = (RRE_O12_TIMING_ENCODED)this.get("TIMING_ENCODED");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public RRE_O12_TIMING_ENCODED getTIMING_ENCODED(int rep) throws HL7Exception { 
	   return (RRE_O12_TIMING_ENCODED)this.get("TIMING_ENCODED", rep);
	}
	...
	/**
	 * Inserts a specific repetition of RRE_O12_TIMING_ENCODED
	 * (a Group object)
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	...
	/**
	 * Removes a specific repetition of RRE_O12_TIMING_ENCODED
	 * (a Group object)
	 * @see AbstractGroup#insertremoveRepetition(String, int) 
	 */
