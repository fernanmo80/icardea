...
public class RSP_Z82_ORDER_DETAIL extends AbstractGroup {
	...
	public RSP_Z82_ORDER_DETAIL(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      this.add(RSP_Z82_TREATMENT.class, false, false);
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating RSP_Z82_ORDER_DETAIL - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public RSP_Z82_TREATMENT getTREATMENT() { 
	   ...
	   try {
	      ret = (RSP_Z82_TREATMENT)this.get("TREATMENT");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
