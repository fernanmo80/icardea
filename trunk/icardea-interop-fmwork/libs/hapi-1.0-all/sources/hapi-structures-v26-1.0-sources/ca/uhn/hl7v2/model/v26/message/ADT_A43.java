 ...
 * 4: ADT_A43_PATIENT (a Group object) <b>repeating</b><br>
 */
public class ADT_A43 extends AbstractMessage  {
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public ADT_A43_PATIENT getPATIENT(int rep) throws HL7Exception { 
	...
	/**
	 * Inserts a specific repetition of ADT_A43_PATIENT
	 * (a Group object)
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	...
	/**
	 * Removes a specific repetition of ADT_A43_PATIENT
	 * (a Group object)
	 * @see AbstractGroup#insertremoveRepetition(String, int) 
	 */
