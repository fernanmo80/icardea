 ...
 * 4: RGV_O15_PATIENT (a Group object) <b>optional </b><br>
 * 5: RGV_O15_ORDER (a Group object) <b>repeating</b><br>
 */
public class RGV_O15 extends AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating RGV_O15 - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public RGV_O15_PATIENT getPATIENT() { 
	   ...
	   try {
	      ret = (RGV_O15_PATIENT)this.get("PATIENT");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	...
	public RGV_O15_ORDER getORDER() { 
	   ...
	   try {
	      ret = (RGV_O15_ORDER)this.get("ORDER");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public RGV_O15_ORDER getORDER(int rep) throws HL7Exception { 
	   return (RGV_O15_ORDER)this.get("ORDER", rep);
	}
	...
	/**
	 * Inserts a specific repetition of RGV_O15_ORDER
	 * (a Group object)
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	...
	/**
	 * Removes a specific repetition of RGV_O15_ORDER
	 * (a Group object)
	 * @see AbstractGroup#insertremoveRepetition(String, int) 
	 */
