...
public class RSP_Z86_COMMON_ORDER extends AbstractGroup {
	 ...
	 */
	public RSP_Z86_TIMING getTIMING(int rep) throws HL7Exception { 
	   return (RSP_Z86_TIMING)this.get("TIMING", rep);
	}
	...
	/**
	 * Inserts a specific repetition of RSP_Z86_TIMING
	 * (a Group object)
	...
	/**
	 * Removes a specific repetition of RSP_Z86_TIMING
	 * (a Group object)
	...
	/**
	 * Inserts a specific repetition of RSP_Z86_OBSERVATION
	 * (a Group object)
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	...
	/**
	 * Removes a specific repetition of RSP_Z86_OBSERVATION
	 * (a Group object)
	 * @see AbstractGroup#insertremoveRepetition(String, int) 
	 */
