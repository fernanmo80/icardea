 ...
 * 6: RRD_O14_RESPONSE (a Group object) <b>optional </b><br>
 */
public class RRD_O14 extends AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating RRD_O14 - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public RRD_O14_RESPONSE getRESPONSE() { 
	   ...
	   try {
	      ret = (RRD_O14_RESPONSE)this.get("RESPONSE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
