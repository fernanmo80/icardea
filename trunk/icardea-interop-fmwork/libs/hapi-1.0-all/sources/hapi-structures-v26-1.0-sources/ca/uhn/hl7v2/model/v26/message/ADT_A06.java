 ...
 * 8: MRG (Merge Patient Information) <b>optional </b><br>
 * 9: NK1 (Next of Kin / Associated Parties) <b>optional repeating</b><br>
 * 10: PV1 (Patient Visit) <b></b><br>
 * 11: PV2 (Patient Visit - Additional Information) <b>optional </b><br>
 * 12: ARV (Access Restriction) <b>optional repeating</b><br>
 ...
 * 19: ADT_A06_PROCEDURE (a Group object) <b>optional repeating</b><br>
 * 20: GT1 (Guarantor) <b>optional repeating</b><br>
 * 21: ADT_A06_INSURANCE (a Group object) <b>optional repeating</b><br>
...
public class ADT_A06 extends AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating ADT_A06 - this is probably a bug in the source code generator.", e);
	   }
	}
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public ADT_A06_PROCEDURE getPROCEDURE(int rep) throws HL7Exception { 
	   return (ADT_A06_PROCEDURE)this.get("PROCEDURE", rep);
	}
	...
	/**
	 * Inserts a specific repetition of ADT_A06_PROCEDURE
	 * (a Group object)
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	...
	/**
	 * Removes a specific repetition of ADT_A06_PROCEDURE
	 * (a Group object)
	 * @see AbstractGroup#insertremoveRepetition(String, int) 
	 */
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public ADT_A06_INSURANCE getINSURANCE(int rep) throws HL7Exception { 
	   return (ADT_A06_INSURANCE)this.get("INSURANCE", rep);
	}
	...
	/**
	 * Inserts a specific repetition of ADT_A06_INSURANCE
	 * (a Group object)
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	...
	/**
	 * Removes a specific repetition of ADT_A06_INSURANCE
	 * (a Group object)
	 * @see AbstractGroup#insertremoveRepetition(String, int) 
	 */
