...
public class OMN_O07_PATIENT extends AbstractGroup {
	...
	public OMN_O07_PATIENT(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      this.add(OMN_O07_PATIENT_VISIT.class, false, false);
	      this.add(OMN_O07_INSURANCE.class, false, true);
	      this.add(GT1.class, false, false);
	      this.add(AL1.class, false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating OMN_O07_PATIENT - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public OMN_O07_PATIENT_VISIT getPATIENT_VISIT() { 
	   ...
	   try {
	      ret = (OMN_O07_PATIENT_VISIT)this.get("PATIENT_VISIT");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	...
	public OMN_O07_INSURANCE getINSURANCE() { 
	   ...
	   try {
	      ret = (OMN_O07_INSURANCE)this.get("INSURANCE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public OMN_O07_INSURANCE getINSURANCE(int rep) throws HL7Exception { 
	   return (OMN_O07_INSURANCE)this.get("INSURANCE", rep);
	}
	...
	/**
	 * Inserts a specific repetition of OMN_O07_INSURANCE
	 * (a Group object)
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	...
	/**
	 * Removes a specific repetition of OMN_O07_INSURANCE
	 * (a Group object)
	 * @see AbstractGroup#insertremoveRepetition(String, int) 
	 */
