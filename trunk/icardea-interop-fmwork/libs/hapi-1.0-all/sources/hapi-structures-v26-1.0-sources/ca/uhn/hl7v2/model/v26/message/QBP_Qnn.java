 ...
 * 7: MSH (Message Header) <b></b><br>
 * 8: SFT (Software Segment) <b>optional repeating</b><br>
 * 9: UAC (User Authentication Credential Segment) <b>optional </b><br>
 * 10: MSA (Message Acknowledgment) <b></b><br>
 * 11: ERR (Error) <b>optional </b><br>
 * 12: QAK (Query Acknowledgment) <b></b><br>
 * 13: QPD (Query Parameter Definition) <b></b><br>
 * 14: Hxx (any HL7 segment) <b></b><br>
 * 15: DSC (Continuation Pointer) <b>optional </b><br>
 */
public class QBP_Qnn extends AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating QBP_Qnn - this is probably a bug in the source code generator.", e);
	   }
	}
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public SFT getSFT2(int rep) throws HL7Exception { 
	   return (SFT)this.get("SFT2", rep);
	}
	...
	/**
	 * Inserts a specific repetition of SFT2
	 * (Software Segment)
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	...
	/**
	 * Removes a specific repetition of SFT2
	 * (Software Segment)
	 * @see AbstractGroup#insertremoveRepetition(String, int) 
	 */
