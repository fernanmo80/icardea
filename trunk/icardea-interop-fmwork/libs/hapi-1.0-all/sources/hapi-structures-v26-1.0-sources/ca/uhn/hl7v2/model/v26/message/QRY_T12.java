...
/**
 * <p>Represents a QRY_T12 message structure (see chapter 9.8.1). This structure contains the 
 * following elements: </p>
 * 0: MSH (Message Header) <b></b><br>
 * 1: QRD (Original-Style Query Definition) <b></b><br>
 * 2: QRF (Original style query filter) <b>optional </b><br>
 */
public class QRY_T12 extends AbstractMessage  {

	/** 
	 * Creates a new QRY_T12 Group with custom ModelClassFactory.
	 */
	public QRY_T12(ModelClassFactory factory) {
	   super(factory);
	   init(factory);
	}
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating QRY_T12 - this is probably a bug in the source code generator.", e);
	   }
	}
