...
public class BLG extends AbstractSegment  {
  ...
  public BLG(Group parent, ModelClassFactory factory) {
    ...
    try {
       this.add(CCD.class, false, 1, 40, new Object[]{message}, "When to Charge");
       this.add(ID.class, false, 1, 50, new Object[]{message, new Integer(122)}, "Charge Type");
       this.add(CX.class, false, 1, 100, new Object[]{message}, "Account ID");
       this.add(CWE.class, false, 1, 60, new Object[]{message}, "Charge Type Reason");
  ...
  public CWE getBlg4_ChargeTypeReason()  {
   ...
   protected Type createNewTypeWithoutReflection(int field) {
      switch (field) {
         case 0: return new ca.uhn.hl7v2.model.v26.datatype.CCD(getMessage());
         case 1: return new ca.uhn.hl7v2.model.v26.datatype.ID(getMessage(), new Integer(122));
