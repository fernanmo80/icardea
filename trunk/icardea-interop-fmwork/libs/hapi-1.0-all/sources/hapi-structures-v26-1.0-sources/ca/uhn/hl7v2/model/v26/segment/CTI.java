 ...
 * CTI-2: Study Phase Identifier (CWE)<br> 
 * CTI-3: Study Scheduled Time Point (CWE)<br> 
...
public class CTI extends AbstractSegment  {
  ...
  public CTI(Group parent, ModelClassFactory factory) {
    ...
    try {
       ...
       this.add(CWE.class, false, 1, 705, new Object[]{message}, "Study Phase Identifier");
       this.add(CWE.class, false, 1, 705, new Object[]{message}, "Study Scheduled Time Point");
