 ...
 * BLC-1: Blood Product Code (CWE)<br> 
...
public class BLC extends AbstractSegment  {
  ...
  public BLC(Group parent, ModelClassFactory factory) {
    ...
    try {
       this.add(CWE.class, false, 1, 250, new Object[]{message}, "Blood Product Code");
       this.add(CQ.class, false, 1, 267, new Object[]{message}, "Blood Amount");
