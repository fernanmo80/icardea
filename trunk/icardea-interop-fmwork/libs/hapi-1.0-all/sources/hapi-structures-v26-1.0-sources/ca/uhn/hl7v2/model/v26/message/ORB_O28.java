 ...
 * 6: ORB_O28_RESPONSE (a Group object) <b>optional </b><br>
 */
public class ORB_O28 extends AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating ORB_O28 - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public ORB_O28_RESPONSE getRESPONSE() { 
	   ...
	   try {
	      ret = (ORB_O28_RESPONSE)this.get("RESPONSE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
