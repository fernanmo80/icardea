 ...
 * 4: BAR_P02_PATIENT (a Group object) <b>repeating</b><br>
 */
public class BAR_P02 extends AbstractMessage  {
	...
	public BAR_P02_PATIENT getPATIENT() { 
	   ...
	   try {
	      ret = (BAR_P02_PATIENT)this.get("PATIENT");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public BAR_P02_PATIENT getPATIENT(int rep) throws HL7Exception { 
	   return (BAR_P02_PATIENT)this.get("PATIENT", rep);
	}
	...
	/**
	 * Inserts a specific repetition of BAR_P02_PATIENT
	 * (a Group object)
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	...
	/**
	 * Removes a specific repetition of BAR_P02_PATIENT
	 * (a Group object)
	 * @see AbstractGroup#insertremoveRepetition(String, int) 
	 */
