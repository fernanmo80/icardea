...
public class ORL_O22_ORDER extends AbstractGroup {
	 ...
	 */
	public ORL_O22_TIMING getTIMING(int rep) throws HL7Exception { 
	   return (ORL_O22_TIMING)this.get("TIMING", rep);
	}
	...
	/**
	 * Inserts a specific repetition of ORL_O22_TIMING
	 * (a Group object)
	...
	/**
	 * Removes a specific repetition of ORL_O22_TIMING
	 * (a Group object)
