...
public class SIU_S12_GENERAL_RESOURCE extends AbstractGroup {
	...
	public SIU_S12_GENERAL_RESOURCE(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating SIU_S12_GENERAL_RESOURCE - this is probably a bug in the source code generator.", e);
	   }
	}
