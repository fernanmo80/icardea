...
public class EHRListener {
    static String template_path="C:\\PROJECTS\\ICARDEA\\EHRListener\\test\\pnr.xml";
    
    public static void main(String[] args) {
        try{
            String res="",cda_path="C:\\PROJECTS\\ICARDEA\\EHRListener\\test\\LABCAT.xml";
    ...
    private static String CreateSoapEnv(String template_path,String boundary_uuid,String cda_content){
        ...
        try{
            ...
            singleNode = (Node) result;
            if (singleNode!=null){
                PATIENT_ID=PATIENT_ID+"^^^&amp;"+ singleNode.getNodeValue()+"&amp;ISO";
            }
            ...
            tmp = tmp.replace("SUBMISSION_SET_UNIQUE_ID", GetUUID());
