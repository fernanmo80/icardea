 ...
 */
        ...
        static String sendDFTMessage(String msg, String ip, int port){
		...
		try{
			...
			//out.writeObject(msg);
                        out.write(msg);
			out.flush();
			System.out.println("DFT sent>" + msg);
                        ...
                        while(true){
                         ...
                         System.out.println("DFT response>" + message);
                         return message;
		}
    ...
    public static String ParseDFT(ca.uhn.hl7v2.model.v22.message.DFT_P03 dftMsg){
        ...
        try{
            ...
            System.out.println("Got DFT message for diagnosis:");
            int num=ft1.getDiagnosisCodeReps();
            for(int i=0;i<num;i++){
               System.out.println(ft1.getDiagnosisCode(i).getCe1_Identifier()+", "+ft1.getDiagnosisCode(i).getCe2_Text()+", "+ft1.getDiagnosisCode(i).getCe3_NameOfCodingSystem());
            }*/
            sendDFTMessage(dftMsg.encode(),Config.GetSetting("DFT_ip"), Integer.parseInt(Config.GetSetting("DFT_port")));
    ...
    public static String ParseADT(ADT_A01 adtMsg){
        String res="", msg_code="";
        String content_items="",problistentries="",dicatentries="", proc_entries="", general="", contents="", labentries="";
        String problist_template="",dicat_template="",contents_template="", general_template="", proc_template="",labentry_template="";
        try{
            ...
            filestr="";
            fs = new FileInputStream(cpath+"\\templates\\dicatentry.xml");
            in = new DataInputStream(fs);
            br = new BufferedReader(new InputStreamReader(in));
            while ((filestr = br.readLine()) != null)
                {
                    dicat_template=dicat_template+filestr+"\r\n";
                }
            in.close();
            ...
            for(int i=0;i<number_of_dg1;i++)
            {
                        ...
                        /*if(prob.getDg13_DiagnosisCode().getCe3_NameOfCodingSystem().getValue().equalsIgnoreCase("UMLS"))
                                ;

                        //CTS call
                        else if(prob.getDg13_DiagnosisCode().getCe1_Identifier().getValue() != null && prob.getDg13_DiagnosisCode().getCe3_NameOfCodingSystem().getValue() != null)
                        {
                            System.out.println("********ASK CTS**********");
                            String cts_res=cts.translateCode(prob.getDg13_DiagnosisCode().getCe3_NameOfCodingSystem().getValue().replace("I10","ICD10"),prob.getDg13_DiagnosisCode().getCe1_Identifier().getValue(), "SNOMEDCT");
            ...
            for(int i=0;i<number_of_al1;i++)
            {
                        ...
                        /*if(prob.getAl13_AllergyCodeMnemonicDescription().getCe3_NameOfCodingSystem().getValue().equalsIgnoreCase("UMLS"))
                                ;
                        //CTS call
                        else if(prob.getAl13_AllergyCodeMnemonicDescription().getCe1_Identifier().getValue() != null && prob.getAl13_AllergyCodeMnemonicDescription().getCe3_NameOfCodingSystem().getValue() != null)
                        {
                            System.out.println("********ASK CTS**********");
                            String cts_res=cts.translateCode(prob.getAl13_AllergyCodeMnemonicDescription().getCe3_NameOfCodingSystem().getValue().replace("I10","ICD10"),prob.getAl13_AllergyCodeMnemonicDescription().getCe1_Identifier().getValue(), "SNOMEDCT");
                            System.out.println("CTS RESULT: "+cts_res);
                            if(cts_res!=null && cts_res.trim().length()>0){
                                    probcode=cts_res;
            ...
            for(int i=0;i<number_of_proc;i++)
            {
                        ...
                        /*if(proc.getProcedureCode().getCe1_Identifier().getValue()!=null && proc.getProcedureCode().getCe3_NameOfCodingSystem().getValue()!=null){
                            System.out.println("********ASK CTS**********");
                            String cts_res=cts.translateCode(proc.getProcedureCode().getCe3_NameOfCodingSystem().getValue().replace("I10","ICD10"),proc.getProcedureCode().getCe1_Identifier().getValue(), "SNOMEDCT");
                            System.out.println("CTS RESULT: "+cts_res);
                            if(cts_res!=null && cts_res.trim().length()>0){
                                    probcode=cts_res;
    ...
    public static String ParseOBX(ORU_R01 adtMsg){
		 ...
		 "</parentDocument>\r\n</relatedDocument>\r\n";
            ...
            try {
                    ...
                    long pix_start=System.currentTimeMillis();
                    String resp=sendMessage(socket_msg);
                    long pix_end=System.currentTimeMillis();
                    Config.pixquery_time.addAndGet( (int)(pix_end-pix_start));
                    ...
                    /*OBX*/
                    /*********FOR THE REVIEW DEMO*********/
                    Map<String,String> demo_codes=new HashMap<String, String>();
                    demo_codes.put("Cl", "C0201952");
                    demo_codes.put("KREA", "C0201975");
                    demo_codes.put("HS_TROP_T", "C0077404");
                    demo_codes.put("HB", "C0518015");
                    demo_codes.put("K_P", "C0202194");
                    demo_codes.put("ZL-0031", "C0202194");
                    demo_codes.put("Na", "C0037473");
                    if(Config.GetSetting("CTS_ENABLED").equals("False")){
                        demo_codes.put("ZL-003", "C0202194");
                        demo_codes.put("ZL-004", "C0037473");
                        demo_codes.put("ZL-562", "C0518015");
                        demo_codes.put("ZL-001", "C0201952");
                        demo_codes.put("ZL-1881", "C0077404");
                        demo_codes.put("ZL-006", "C0201975");
                    }
                    /*************************************/
                    ...
                    for(int i=0;i<number_of_obx;i++)
                    {
                        ...
                        if("SN".equals(obx.getObx2_ValueType().getValue()))
                        {
                            System.out.println("Observation type SN ignored!!!!");
                            continue;
                        ...
                        else if("NM".equals(obx.getObx2_ValueType().getValue()))
                        {
                            ...
                            System.out.println("Ignored unkown observation type!!!!");
                            continue;
                        }
                        /*********FOR THE REVIEW DEMO*********/
                        //if(obx.getObservationIdentifier().getText().toString()!=null && obx.getObservationIdentifier().getText().toString().equalsIgnoreCase("eGFR"))
                          //  continue;
                        if(obx.getObservationIdentifier().getIdentifier().toString()!=null && demo_codes.containsKey(obx.getObservationIdentifier().getIdentifier().toString())){
                            labcode=demo_codes.get(obx.getObservationIdentifier().getIdentifier().toString()).toString();
                        ...
                        /*************************************/
                        //CTS call
                        else if(obx.getObservationIdentifier().getIdentifier().toString() != null && obx.getObservationIdentifier().getNameOfCodingSystem().getValue() != null)
                        {
                            System.out.println("********ASK CTS**********");
                            ...
                            if(cts_res!=null && cts_res.trim().length()>0){
                                ...
                                System.out.println("Cannot map '"+obx.getObservationIdentifier().getIdentifier().toString()+"' code. Observation ignored!!!");
                                continue;
                            }
                          }
