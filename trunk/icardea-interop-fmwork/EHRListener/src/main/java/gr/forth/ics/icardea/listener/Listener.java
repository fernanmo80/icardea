...
public class Listener {
    ...
    public static String Provide_Register(String doc_id,String cda_path,String xds_url){
       ...
       String res="",cda_content="";
            try{
                ...
                /*System.out.println("START OF SOPEAENV:");
                System.out.println(SoapEnv);
                System.out.println("END OF SOPEAENV:");*/
    ...
    public static void main(String[] args){
                try{
                    String res="";
                    String xds_url="http://139.91.190.45:9080/xds/";
                    String cda_path="C:\\PROJECTS\\ICARDEA\\Listener\\EHRListener\\EPSOS-CDA-Document.xml";
