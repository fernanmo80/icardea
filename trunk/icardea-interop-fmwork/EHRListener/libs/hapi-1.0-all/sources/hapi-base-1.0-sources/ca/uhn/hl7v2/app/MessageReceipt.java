...
/**
 * Returned by <code>Connection.reserveResponse()</code> when calling 
 * classes want to wait for a particular response message.  
...
class MessageReceipt {
    ...
    /** Sets the text of the message and notifies waiting threads. */
    public synchronized void setMessage(String messageText) {
        message = messageText;
        this.notifyAll();
    }
    
    /** Returns the message text if it has arrived, otherwise null. */
