 ...
 * 4: MFN_Znn_MF_SITE_DEFINED (a Group object) <b>repeating</b><br>
 */
public class MFN_Znn extends AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating MFN_Znn - this is probably a bug in the source code generator.", e);
	   }
	}
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public MFN_Znn_MF_SITE_DEFINED getMF_SITE_DEFINED(int rep) throws HL7Exception { 
	   return (MFN_Znn_MF_SITE_DEFINED)this.get("MF_SITE_DEFINED", rep);
	}
	...
	/**
	 * Inserts a specific repetition of MFN_Znn_MF_SITE_DEFINED
	 * (a Group object)
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	...
	/**
	 * Removes a specific repetition of MFN_Znn_MF_SITE_DEFINED
	 * (a Group object)
	 * @see AbstractGroup#insertremoveRepetition(String, int) 
	 */
