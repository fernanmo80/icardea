...
/**
 * <p>Represents the OPR_O38_TIMING Group.  A Group is an ordered collection of message 
 * segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements: </p>
 * 0: TQ1 (Timing/Quantity) <b></b><br>
 * 1: TQ2 (Timing/Quantity Relationship) <b>optional repeating</b><br>
 */
public class OPR_O38_TIMING extends AbstractGroup {

	/** 
	 * Creates a new OPR_O38_TIMING Group.
	 */
	public OPR_O38_TIMING(Group parent, ModelClassFactory factory) {
	   super(parent, factory);
	   try {
	      this.add(TQ1.class, true, false);
	      this.add(TQ2.class, false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating OPR_O38_TIMING - this is probably a bug in the source code generator.", e);
	   }
	}
