 ...
 * 5: ROR_ROR_DEFINITION (a Group object) <b>repeating</b><br>
...
public class ROR_ROR extends AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating ROR_ROR - this is probably a bug in the source code generator.", e);
	   }
	}
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public ROR_ROR_DEFINITION getDEFINITION(int rep) throws HL7Exception { 
	   return (ROR_ROR_DEFINITION)this.get("DEFINITION", rep);
	}
	...
	/**
	 * Inserts a specific repetition of ROR_ROR_DEFINITION
	 * (a Group object)
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	...
	/**
	 * Removes a specific repetition of ROR_ROR_DEFINITION
	 * (a Group object)
	 * @see AbstractGroup#insertremoveRepetition(String, int) 
	 */
