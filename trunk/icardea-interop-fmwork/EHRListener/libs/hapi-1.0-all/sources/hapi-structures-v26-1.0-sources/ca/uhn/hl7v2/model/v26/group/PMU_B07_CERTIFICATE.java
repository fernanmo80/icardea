...
public class PMU_B07_CERTIFICATE extends AbstractGroup {
	...
	public PMU_B07_CERTIFICATE(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      this.add(CER.class, true, false);
	      this.add(ROL.class, false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating PMU_B07_CERTIFICATE - this is probably a bug in the source code generator.", e);
	   }
	}
