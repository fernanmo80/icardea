...
public class MDM_T02_COMMON_ORDER extends AbstractGroup {
	...
	public MDM_T02_COMMON_ORDER(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      this.add(MDM_T02_TIMING.class, false, true);
	      this.add(OBR.class, true, false);
	      this.add(NTE.class, false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating MDM_T02_COMMON_ORDER - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public MDM_T02_TIMING getTIMING() { 
	   ...
	   try {
	      ret = (MDM_T02_TIMING)this.get("TIMING");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 */
	public MDM_T02_TIMING getTIMING(int rep) throws HL7Exception { 
	   return (MDM_T02_TIMING)this.get("TIMING", rep);
	}
	...
	/**
	 * Inserts a specific repetition of MDM_T02_TIMING
	 * (a Group object)
	...
	/**
	 * Removes a specific repetition of MDM_T02_TIMING
	 * (a Group object)
