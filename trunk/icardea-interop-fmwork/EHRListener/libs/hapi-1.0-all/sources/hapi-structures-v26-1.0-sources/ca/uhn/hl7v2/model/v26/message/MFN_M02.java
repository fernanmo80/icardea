 ...
 * 4: MFN_M02_MF_STAFF (a Group object) <b>repeating</b><br>
 */
public class MFN_M02 extends AbstractMessage  {
	...
	public MFN_M02_MF_STAFF getMF_STAFF() { 
	   ...
	   try {
	      ret = (MFN_M02_MF_STAFF)this.get("MF_STAFF");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public MFN_M02_MF_STAFF getMF_STAFF(int rep) throws HL7Exception { 
	   return (MFN_M02_MF_STAFF)this.get("MF_STAFF", rep);
	}
	...
	/**
	 * Inserts a specific repetition of MFN_M02_MF_STAFF
	 * (a Group object)
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	...
	/**
	 * Removes a specific repetition of MFN_M02_MF_STAFF
	 * (a Group object)
	 * @see AbstractGroup#insertremoveRepetition(String, int) 
	 */
