...
/**
 * <p>Represents a RSP_E22 message structure (see chapter 16.3.13). This structure contains the 
 ...
 * 7: RSP_E22_AUTHORIZATION_INFO (a Group object) <b>optional </b><br>
 */
public class RSP_E22 extends AbstractMessage  {

	/** 
	 * Creates a new RSP_E22 Group with custom ModelClassFactory.
	 */
	public RSP_E22(ModelClassFactory factory) {
	   super(factory);
	   init(factory);
	}
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      this.add(RSP_E22_AUTHORIZATION_INFO.class, false, false);
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating RSP_E22 - this is probably a bug in the source code generator.", e);
	   }
	}
	 ...
	 */
	public RSP_E22_AUTHORIZATION_INFO getAUTHORIZATION_INFO() { 
	   RSP_E22_AUTHORIZATION_INFO ret = null;
	   try {
	      ret = (RSP_E22_AUTHORIZATION_INFO)this.get("AUTHORIZATION_INFO");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
