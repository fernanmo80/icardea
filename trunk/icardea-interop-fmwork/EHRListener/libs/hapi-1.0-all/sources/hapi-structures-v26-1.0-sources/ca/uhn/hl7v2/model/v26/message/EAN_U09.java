 ...
 * 4: EAN_U09_NOTIFICATION (a Group object) <b>repeating</b><br>
...
public class EAN_U09 extends AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating EAN_U09 - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public EAN_U09_NOTIFICATION getNOTIFICATION() { 
	   ...
	   try {
	      ret = (EAN_U09_NOTIFICATION)this.get("NOTIFICATION");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public EAN_U09_NOTIFICATION getNOTIFICATION(int rep) throws HL7Exception { 
	   return (EAN_U09_NOTIFICATION)this.get("NOTIFICATION", rep);
	}
	...
	/**
	 * Inserts a specific repetition of EAN_U09_NOTIFICATION
	 * (a Group object)
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	...
	/**
	 * Removes a specific repetition of EAN_U09_NOTIFICATION
	 * (a Group object)
	 * @see AbstractGroup#insertremoveRepetition(String, int) 
	 */
