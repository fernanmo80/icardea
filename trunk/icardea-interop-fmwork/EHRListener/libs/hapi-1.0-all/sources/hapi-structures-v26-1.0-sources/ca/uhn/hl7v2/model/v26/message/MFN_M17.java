...
/**
 * <p>Represents a MFN_M17 message structure (see chapter 8.13.1). This structure contains the 
 * following elements: </p>
 * 0: MSH (Message Header) <b></b><br>
 * 1: SFT (Software Segment) <b>optional repeating</b><br>
 * 2: UAC (User Authentication Credential Segment) <b>optional </b><br>
 * 3: MFI (Master File Identification) <b></b><br>
 * 4: MFN_M17_MF_DRG (a Group object) <b>repeating</b><br>
 */
public class MFN_M17 extends AbstractMessage  {

	/** 
	 * Creates a new MFN_M17 Group with custom ModelClassFactory.
	 */
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating MFN_M17 - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public MFN_M17_MF_DRG getMF_DRG() { 
	   ...
	   try {
	      ret = (MFN_M17_MF_DRG)this.get("MF_DRG");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public MFN_M17_MF_DRG getMF_DRG(int rep) throws HL7Exception { 
	   return (MFN_M17_MF_DRG)this.get("MF_DRG", rep);
	}
	...
	/**
	 * Inserts a specific repetition of MFN_M17_MF_DRG
	 * (a Group object)
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	...
	/**
	 * Removes a specific repetition of MFN_M17_MF_DRG
	 * (a Group object)
	 * @see AbstractGroup#insertremoveRepetition(String, int) 
	 */
