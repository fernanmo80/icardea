 ...
 * 6: RRA_O18_RESPONSE (a Group object) <b>optional </b><br>
 */
public class RRA_O18 extends AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating RRA_O18 - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public RRA_O18_RESPONSE getRESPONSE() { 
	   ...
	   try {
	      ret = (RRA_O18_RESPONSE)this.get("RESPONSE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
