...
public class OMS_O05_PATIENT extends AbstractGroup {
	...
	public OMS_O05_PATIENT(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      this.add(OMS_O05_PATIENT_VISIT.class, false, false);
	      this.add(OMS_O05_INSURANCE.class, false, true);
	      this.add(GT1.class, false, false);
	      this.add(AL1.class, false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating OMS_O05_PATIENT - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public OMS_O05_PATIENT_VISIT getPATIENT_VISIT() { 
	   ...
	   try {
	      ret = (OMS_O05_PATIENT_VISIT)this.get("PATIENT_VISIT");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	...
	public OMS_O05_INSURANCE getINSURANCE() { 
	   ...
	   try {
	      ret = (OMS_O05_INSURANCE)this.get("INSURANCE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public OMS_O05_INSURANCE getINSURANCE(int rep) throws HL7Exception { 
	   return (OMS_O05_INSURANCE)this.get("INSURANCE", rep);
	}
	...
	/**
	 * Inserts a specific repetition of OMS_O05_INSURANCE
	 * (a Group object)
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	...
	/**
	 * Removes a specific repetition of OMS_O05_INSURANCE
	 * (a Group object)
	 * @see AbstractGroup#insertremoveRepetition(String, int) 
	 */
