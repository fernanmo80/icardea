...
public class DB1 extends AbstractSegment  {
  ...
  public DB1(Group parent, ModelClassFactory factory) {
    ...
    try {
       this.add(SI.class, true, 1, 4, new Object[]{message}, "Set ID - DB1");
       this.add(IS.class, false, 1, 2, new Object[]{message, new Integer(334)}, "Disabled Person Code");
       this.add(CX.class, false, 0, 250, new Object[]{message}, "Disabled Person Identifier");
       this.add(ID.class, false, 1, 1, new Object[]{message, new Integer(136)}, "Disability Indicator");
       this.add(DT.class, false, 1, 8, new Object[]{message}, "Disability Start Date");
       this.add(DT.class, false, 1, 8, new Object[]{message}, "Disability End Date");
       this.add(DT.class, false, 1, 8, new Object[]{message}, "Disability Return to Work Date");
       this.add(DT.class, false, 1, 8, new Object[]{message}, "Disability Unable to Work Date");
  ...
  /**
   * Returns a count of the number of repetitions of Disabled Person Identifier (DB1-3).
   */
  ...
  /**
   * Inserts a repetition of Disabled Person Identifier (DB1-3) at a given index and returns it.
   * @param index The index
   */
  public CX insertDisabledPersonIdentifier(int index) throws HL7Exception {
     return (CX) super.insertRepetition(3, index);
  }

  /**
   * Removes a repetition of Disabled Person Identifier (DB1-3) at a given index and returns it.
   * @param index The index
   */
  public CX removeDisabledPersonIdentifier(int index) throws HL7Exception {
   ...
   * @throws HL7Exception if the repetition number is invalid.
   */
  public CX getDb13_DisabledPersonIdentifier(int rep) throws HL7Exception {
    CX ret = null;
    try {
        Type t = this.getField(3, rep);
        ret = (CX)t;
   ...
   * @param index The index
   */
  public CX insertDb13_DisabledPersonIdentifier(int index) throws HL7Exception {
     return (CX) super.insertRepetition(3, index);
  }
   ...
   * @param index The index
   */
  public CX removeDb13_DisabledPersonIdentifier(int index) throws HL7Exception {
     return (CX) super.removeRepetition(3, index);
  }
  ...
  public DT getDb18_DisabilityUnableToWorkDate()  {
   ...
   protected Type createNewTypeWithoutReflection(int field) {
      switch (field) {
         ...
         case 1: return new ca.uhn.hl7v2.model.v26.datatype.IS(getMessage(), new Integer(334));
         ...
         case 6: return new ca.uhn.hl7v2.model.v26.datatype.DT(getMessage());
