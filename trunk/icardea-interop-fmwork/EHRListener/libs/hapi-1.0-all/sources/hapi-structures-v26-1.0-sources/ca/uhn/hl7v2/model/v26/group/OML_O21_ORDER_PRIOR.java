 ...
 * 4: OML_O21_TIMING_PRIOR (a Group object) <b>optional repeating</b><br>
 * 5: OML_O21_OBSERVATION_PRIOR (a Group object) <b>repeating</b><br>
 */
public class OML_O21_ORDER_PRIOR extends AbstractGroup {
	...
	public OML_O21_ORDER_PRIOR(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      this.add(OML_O21_TIMING_PRIOR.class, false, true);
	      this.add(OML_O21_OBSERVATION_PRIOR.class, true, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating OML_O21_ORDER_PRIOR - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public OML_O21_TIMING_PRIOR getTIMING_PRIOR() { 
	   ...
	   try {
	      ret = (OML_O21_TIMING_PRIOR)this.get("TIMING_PRIOR");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public OML_O21_TIMING_PRIOR getTIMING_PRIOR(int rep) throws HL7Exception { 
	   return (OML_O21_TIMING_PRIOR)this.get("TIMING_PRIOR", rep);
	}
	...
	/**
	 * Inserts a specific repetition of OML_O21_TIMING_PRIOR
	 * (a Group object)
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	...
	/**
	 * Removes a specific repetition of OML_O21_TIMING_PRIOR
	 * (a Group object)
	 * @see AbstractGroup#insertremoveRepetition(String, int) 
	 */
	...
	public OML_O21_OBSERVATION_PRIOR getOBSERVATION_PRIOR() { 
	   ...
	   try {
	      ret = (OML_O21_OBSERVATION_PRIOR)this.get("OBSERVATION_PRIOR");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public OML_O21_OBSERVATION_PRIOR getOBSERVATION_PRIOR(int rep) throws HL7Exception { 
	   return (OML_O21_OBSERVATION_PRIOR)this.get("OBSERVATION_PRIOR", rep);
	}
	...
	/**
	 * Inserts a specific repetition of OML_O21_OBSERVATION_PRIOR
	 * (a Group object)
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	...
	/**
	 * Removes a specific repetition of OML_O21_OBSERVATION_PRIOR
	 * (a Group object)
	 * @see AbstractGroup#insertremoveRepetition(String, int) 
	 */
