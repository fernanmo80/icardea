 ...
 * RXR-3: Administration Device (CWE)<br> 
 * RXR-4: Administration Method (CWE)<br> 
 * RXR-5: Routing Instruction (CWE)<br> 
...
public class RXR extends AbstractSegment  {
  ...
  public RXR(Group parent, ModelClassFactory factory) {
    ...
    try {
       this.add(CWE.class, true, 1, 250, new Object[]{message}, "Route");
       this.add(CWE.class, false, 1, 250, new Object[]{message}, "Administration Site");
       this.add(CWE.class, false, 1, 250, new Object[]{message}, "Administration Device");
       this.add(CWE.class, false, 1, 250, new Object[]{message}, "Administration Method");
       this.add(CWE.class, false, 1, 250, new Object[]{message}, "Routing Instruction");
       this.add(CWE.class, false, 1, 250, new Object[]{message}, "Administration Site Modifier");
