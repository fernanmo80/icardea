 ...
 * 8: RSP_Z90_QUERY_RESPONSE (a Group object) <b>repeating</b><br>
...
public class RSP_Z90 extends AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating RSP_Z90 - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public RSP_Z90_QUERY_RESPONSE getQUERY_RESPONSE() { 
	   ...
	   try {
	      ret = (RSP_Z90_QUERY_RESPONSE)this.get("QUERY_RESPONSE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public RSP_Z90_QUERY_RESPONSE getQUERY_RESPONSE(int rep) throws HL7Exception { 
	   return (RSP_Z90_QUERY_RESPONSE)this.get("QUERY_RESPONSE", rep);
	}
	...
	/**
	 * Inserts a specific repetition of RSP_Z90_QUERY_RESPONSE
	 * (a Group object)
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	...
	/**
	 * Removes a specific repetition of RSP_Z90_QUERY_RESPONSE
	 * (a Group object)
	 * @see AbstractGroup#insertremoveRepetition(String, int) 
	 */
