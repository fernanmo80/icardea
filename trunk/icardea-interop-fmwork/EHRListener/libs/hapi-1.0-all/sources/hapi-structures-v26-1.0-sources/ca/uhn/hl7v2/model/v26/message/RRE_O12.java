 ...
 * 6: RRE_O12_RESPONSE (a Group object) <b>optional </b><br>
 */
public class RRE_O12 extends AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating RRE_O12 - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public RRE_O12_RESPONSE getRESPONSE() { 
	   ...
	   try {
	      ret = (RRE_O12_RESPONSE)this.get("RESPONSE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
