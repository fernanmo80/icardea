...
public class ORL_O34_RESPONSE extends AbstractGroup {
	...
	public ORL_O34_RESPONSE(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      this.add(ORL_O34_SPECIMEN.class, true, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating ORL_O34_RESPONSE - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public ORL_O34_SPECIMEN getSPECIMEN() { 
	   ...
	   try {
	      ret = (ORL_O34_SPECIMEN)this.get("SPECIMEN");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 */
	public ORL_O34_SPECIMEN getSPECIMEN(int rep) throws HL7Exception { 
	   return (ORL_O34_SPECIMEN)this.get("SPECIMEN", rep);
	}
	...
	/**
	 * Inserts a specific repetition of ORL_O34_SPECIMEN
	 * (a Group object)
	...
	/**
	 * Removes a specific repetition of ORL_O34_SPECIMEN
	 * (a Group object)
