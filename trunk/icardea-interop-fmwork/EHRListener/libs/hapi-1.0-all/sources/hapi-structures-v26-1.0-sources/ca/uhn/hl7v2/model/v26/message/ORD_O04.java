 ...
 * 6: ORD_O04_RESPONSE (a Group object) <b>optional </b><br>
 */
public class ORD_O04 extends AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating ORD_O04 - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public ORD_O04_RESPONSE getRESPONSE() { 
	   ...
	   try {
	      ret = (ORD_O04_RESPONSE)this.get("RESPONSE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
