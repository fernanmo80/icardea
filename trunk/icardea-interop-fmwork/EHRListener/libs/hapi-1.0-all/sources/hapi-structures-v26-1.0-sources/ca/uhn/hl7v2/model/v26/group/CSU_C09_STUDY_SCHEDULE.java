...
public class CSU_C09_STUDY_SCHEDULE extends AbstractGroup {
	 ...
	 */
	public CSU_C09_STUDY_OBSERVATION getSTUDY_OBSERVATION(int rep) throws HL7Exception { 
	   return (CSU_C09_STUDY_OBSERVATION)this.get("STUDY_OBSERVATION", rep);
	}
	...
	/**
	 * Inserts a specific repetition of CSU_C09_STUDY_OBSERVATION
	 * (a Group object)
	...
	/**
	 * Removes a specific repetition of CSU_C09_STUDY_OBSERVATION
	 * (a Group object)
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public CSU_C09_STUDY_PHARM getSTUDY_PHARM(int rep) throws HL7Exception { 
	   return (CSU_C09_STUDY_PHARM)this.get("STUDY_PHARM", rep);
	}
	...
	/**
	 * Inserts a specific repetition of CSU_C09_STUDY_PHARM
	 * (a Group object)
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	...
	/**
	 * Removes a specific repetition of CSU_C09_STUDY_PHARM
	 * (a Group object)
	 * @see AbstractGroup#insertremoveRepetition(String, int) 
	 */
