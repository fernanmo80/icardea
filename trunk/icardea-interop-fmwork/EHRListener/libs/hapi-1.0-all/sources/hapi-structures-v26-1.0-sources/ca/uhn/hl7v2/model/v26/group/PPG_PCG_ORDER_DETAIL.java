...
public class PPG_PCG_ORDER_DETAIL extends AbstractGroup {
	...
	public PPG_PCG_ORDER_DETAIL(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      this.add(PPG_PCG_ORDER_OBSERVATION.class, false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating PPG_PCG_ORDER_DETAIL - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public PPG_PCG_ORDER_OBSERVATION getORDER_OBSERVATION() { 
	   ...
	   try {
	      ret = (PPG_PCG_ORDER_OBSERVATION)this.get("ORDER_OBSERVATION");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public PPG_PCG_ORDER_OBSERVATION getORDER_OBSERVATION(int rep) throws HL7Exception { 
	   return (PPG_PCG_ORDER_OBSERVATION)this.get("ORDER_OBSERVATION", rep);
	}
	...
	/**
	 * Inserts a specific repetition of PPG_PCG_ORDER_OBSERVATION
	 * (a Group object)
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	...
	/**
	 * Removes a specific repetition of PPG_PCG_ORDER_OBSERVATION
	 * (a Group object)
	 * @see AbstractGroup#insertremoveRepetition(String, int) 
	 */
