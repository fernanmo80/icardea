...
public class RQA_I08_OBSERVATION extends AbstractGroup {
	...
	public RQA_I08_OBSERVATION(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      this.add(RQA_I08_RESULTS.class, false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating RQA_I08_OBSERVATION - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public RQA_I08_RESULTS getRESULTS() { 
	   ...
	   try {
	      ret = (RQA_I08_RESULTS)this.get("RESULTS");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public RQA_I08_RESULTS getRESULTS(int rep) throws HL7Exception { 
	   return (RQA_I08_RESULTS)this.get("RESULTS", rep);
	}
	...
	/**
	 * Inserts a specific repetition of RQA_I08_RESULTS
	 * (a Group object)
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	...
	/**
	 * Removes a specific repetition of RQA_I08_RESULTS
	 * (a Group object)
	 * @see AbstractGroup#insertremoveRepetition(String, int) 
	 */
