 ...
 * 4: BPS_O29_PATIENT (a Group object) <b>optional </b><br>
 * 5: BPS_O29_ORDER (a Group object) <b>repeating</b><br>
 */
public class BPS_O29 extends AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating BPS_O29 - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public BPS_O29_PATIENT getPATIENT() { 
	   ...
	   try {
	      ret = (BPS_O29_PATIENT)this.get("PATIENT");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	...
	public BPS_O29_ORDER getORDER() { 
	   ...
	   try {
	      ret = (BPS_O29_ORDER)this.get("ORDER");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public BPS_O29_ORDER getORDER(int rep) throws HL7Exception { 
	   return (BPS_O29_ORDER)this.get("ORDER", rep);
	}
	...
	/**
	 * Inserts a specific repetition of BPS_O29_ORDER
	 * (a Group object)
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	...
	/**
	 * Removes a specific repetition of BPS_O29_ORDER
	 * (a Group object)
	 * @see AbstractGroup#insertremoveRepetition(String, int) 
	 */
