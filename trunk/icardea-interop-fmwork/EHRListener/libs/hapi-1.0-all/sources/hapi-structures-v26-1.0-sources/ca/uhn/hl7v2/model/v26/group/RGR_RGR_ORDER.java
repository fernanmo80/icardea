...
public class RGR_RGR_ORDER extends AbstractGroup {
	...
	public RGR_RGR_ORDER(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      this.add(RGR_RGR_ENCODING.class, false, false);
	      this.add(RXG.class, true, true);
	      this.add(RXR.class, true, true);
	      this.add(RXC.class, false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating RGR_RGR_ORDER - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public RGR_RGR_ENCODING getENCODING() { 
	   ...
	   try {
	      ret = (RGR_RGR_ENCODING)this.get("ENCODING");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	...
	/**
	 * Inserts a specific repetition of RXG
	...
	/**
	 * Removes a specific repetition of RXG
	 * (Pharmacy/Treatment Give)
