...
public class OMG_O19_PATIENT extends AbstractGroup {
	...
	public OMG_O19_PATIENT(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      this.add(OMG_O19_PATIENT_VISIT.class, false, false);
	      this.add(OMG_O19_INSURANCE.class, false, true);
	      this.add(GT1.class, false, false);
	      this.add(AL1.class, false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating OMG_O19_PATIENT - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public OMG_O19_PATIENT_VISIT getPATIENT_VISIT() { 
	   ...
	   try {
	      ret = (OMG_O19_PATIENT_VISIT)this.get("PATIENT_VISIT");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	...
	public OMG_O19_INSURANCE getINSURANCE() { 
	   ...
	   try {
	      ret = (OMG_O19_INSURANCE)this.get("INSURANCE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public OMG_O19_INSURANCE getINSURANCE(int rep) throws HL7Exception { 
	   return (OMG_O19_INSURANCE)this.get("INSURANCE", rep);
	}
	...
	/**
	 * Inserts a specific repetition of OMG_O19_INSURANCE
	 * (a Group object)
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	...
	/**
	 * Removes a specific repetition of OMG_O19_INSURANCE
	 * (a Group object)
	 * @see AbstractGroup#insertremoveRepetition(String, int) 
	 */
