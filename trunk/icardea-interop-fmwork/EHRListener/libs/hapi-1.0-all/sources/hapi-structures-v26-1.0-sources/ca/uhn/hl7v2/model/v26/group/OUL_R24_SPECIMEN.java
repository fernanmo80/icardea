...
public class OUL_R24_SPECIMEN extends AbstractGroup {
	...
	public OUL_R24_SPECIMEN(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      this.add(OUL_R24_CONTAINER.class, false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating OUL_R24_SPECIMEN - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public OUL_R24_CONTAINER getCONTAINER() { 
	   ...
	   try {
	      ret = (OUL_R24_CONTAINER)this.get("CONTAINER");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public OUL_R24_CONTAINER getCONTAINER(int rep) throws HL7Exception { 
	   return (OUL_R24_CONTAINER)this.get("CONTAINER", rep);
	}
	...
	/**
	 * Inserts a specific repetition of OUL_R24_CONTAINER
	 * (a Group object)
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	...
	/**
	 * Removes a specific repetition of OUL_R24_CONTAINER
	 * (a Group object)
	 * @see AbstractGroup#insertremoveRepetition(String, int) 
	 */
