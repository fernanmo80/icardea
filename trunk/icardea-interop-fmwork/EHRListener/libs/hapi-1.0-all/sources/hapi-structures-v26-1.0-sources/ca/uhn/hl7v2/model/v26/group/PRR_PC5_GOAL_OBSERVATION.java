...
public class PRR_PC5_GOAL_OBSERVATION extends AbstractGroup {
	...
	public PRR_PC5_GOAL_OBSERVATION(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating PRR_PC5_GOAL_OBSERVATION - this is probably a bug in the source code generator.", e);
	   }
	}
