 ...
 * 6: ORS_O06_RESPONSE (a Group object) <b>optional </b><br>
 */
public class ORS_O06 extends AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating ORS_O06 - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public ORS_O06_RESPONSE getRESPONSE() { 
	   ...
	   try {
	      ret = (ORS_O06_RESPONSE)this.get("RESPONSE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
