...
public class OMN_O07_ORDER extends AbstractGroup {
	 ...
	 */
	public OMN_O07_TIMING getTIMING(int rep) throws HL7Exception { 
	   return (OMN_O07_TIMING)this.get("TIMING", rep);
	}
	...
	/**
	 * Inserts a specific repetition of OMN_O07_TIMING
	 * (a Group object)
	...
	/**
	 * Removes a specific repetition of OMN_O07_TIMING
	 * (a Group object)
	...
	/**
	 * Inserts a specific repetition of OMN_O07_OBSERVATION
	 * (a Group object)
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	...
	/**
	 * Removes a specific repetition of OMN_O07_OBSERVATION
	 * (a Group object)
	 * @see AbstractGroup#insertremoveRepetition(String, int) 
	 */
