 ...
 * 3: NMQ_N01_QRY_WITH_DETAIL (a Group object) <b>optional </b><br>
 * 4: NMQ_N01_CLOCK_AND_STATISTICS (a Group object) <b>repeating</b><br>
 */
public class NMQ_N01 extends AbstractMessage  {
	...
	/**
	 * Inserts a specific repetition of NMQ_N01_CLOCK_AND_STATISTICS
	 * (a Group object)
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	...
	/**
	 * Removes a specific repetition of NMQ_N01_CLOCK_AND_STATISTICS
	 * (a Group object)
	 * @see AbstractGroup#insertremoveRepetition(String, int) 
	 */
