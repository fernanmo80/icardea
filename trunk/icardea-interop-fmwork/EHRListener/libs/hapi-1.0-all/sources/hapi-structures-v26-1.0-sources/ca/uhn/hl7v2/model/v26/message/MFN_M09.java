 ...
 * 4: MFN_M09_MF_TEST_CATEGORICAL (a Group object) <b>repeating</b><br>
 */
public class MFN_M09 extends AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating MFN_M09 - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public MFN_M09_MF_TEST_CATEGORICAL getMF_TEST_CATEGORICAL() { 
	   ...
	   try {
	      ret = (MFN_M09_MF_TEST_CATEGORICAL)this.get("MF_TEST_CATEGORICAL");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public MFN_M09_MF_TEST_CATEGORICAL getMF_TEST_CATEGORICAL(int rep) throws HL7Exception { 
	   return (MFN_M09_MF_TEST_CATEGORICAL)this.get("MF_TEST_CATEGORICAL", rep);
	}
	...
	/**
	 * Inserts a specific repetition of MFN_M09_MF_TEST_CATEGORICAL
	 * (a Group object)
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	...
	/**
	 * Removes a specific repetition of MFN_M09_MF_TEST_CATEGORICAL
	 * (a Group object)
	 * @see AbstractGroup#insertremoveRepetition(String, int) 
	 */
