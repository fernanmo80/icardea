...
/**
 * <p>Represents the MFR_M06_MF_PHASE_SCHED_DETAIL Group.  A Group is an ordered collection of message 
 ...
 */
public class MFR_M06_MF_PHASE_SCHED_DETAIL extends AbstractGroup {

	/** 
	 * Creates a new MFR_M06_MF_PHASE_SCHED_DETAIL Group.
	 */
	public MFR_M06_MF_PHASE_SCHED_DETAIL(Group parent, ModelClassFactory factory) {
	   super(parent, factory);
	   try {
	      this.add(CM1.class, true, false);
	      this.add(CM2.class, false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating MFR_M06_MF_PHASE_SCHED_DETAIL - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	/**
	 * Inserts a specific repetition of CM2
	...
	/**
	 * Removes a specific repetition of CM2
	 * (Clinical Study Schedule Master)
