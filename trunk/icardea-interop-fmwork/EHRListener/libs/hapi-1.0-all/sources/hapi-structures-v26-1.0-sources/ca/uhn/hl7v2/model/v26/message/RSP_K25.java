 ...
 * 8: RSP_K25_STAFF (a Group object) <b>repeating</b><br>
...
public class RSP_K25 extends AbstractMessage  {
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public RSP_K25_STAFF getSTAFF(int rep) throws HL7Exception { 
	   return (RSP_K25_STAFF)this.get("STAFF", rep);
	}
	...
	/**
	 * Inserts a specific repetition of RSP_K25_STAFF
	 * (a Group object)
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	...
	/**
	 * Removes a specific repetition of RSP_K25_STAFF
	 * (a Group object)
	 * @see AbstractGroup#insertremoveRepetition(String, int) 
	 */
