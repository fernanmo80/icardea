...
public class OML_O33_SPECIMEN extends AbstractGroup {
	...
	public OML_O33_SPECIMEN(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      this.add(OML_O33_ORDER.class, true, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating OML_O33_SPECIMEN - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public OML_O33_ORDER getORDER() { 
	   ...
	   try {
	      ret = (OML_O33_ORDER)this.get("ORDER");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public OML_O33_ORDER getORDER(int rep) throws HL7Exception { 
	   return (OML_O33_ORDER)this.get("ORDER", rep);
	}
	...
	/**
	 * Inserts a specific repetition of OML_O33_ORDER
	 * (a Group object)
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	...
	/**
	 * Removes a specific repetition of OML_O33_ORDER
	 * (a Group object)
	 * @see AbstractGroup#insertremoveRepetition(String, int) 
	 */
