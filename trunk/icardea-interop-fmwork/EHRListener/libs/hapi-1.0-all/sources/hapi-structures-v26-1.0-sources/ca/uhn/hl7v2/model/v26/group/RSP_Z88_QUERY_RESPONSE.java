...
public class RSP_Z88_QUERY_RESPONSE extends AbstractGroup {
	...
	public RSP_Z88_QUERY_RESPONSE(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating RSP_Z88_QUERY_RESPONSE - this is probably a bug in the source code generator.", e);
	   }
	}
	 ...
	 */
	public RSP_Z88_COMMON_ORDER getCOMMON_ORDER(int rep) throws HL7Exception { 
	   return (RSP_Z88_COMMON_ORDER)this.get("COMMON_ORDER", rep);
	}
	...
	/**
	 * Inserts a specific repetition of RSP_Z88_COMMON_ORDER
	 * (a Group object)
	...
	/**
	 * Removes a specific repetition of RSP_Z88_COMMON_ORDER
	 * (a Group object)
