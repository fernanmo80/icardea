 ...
 * 5: EHC_E04_PRODUCT_SERVICE_SECTION (a Group object) <b>optional repeating</b><br>
 */
public class EHC_E04 extends AbstractMessage  {

	/** 
	 * Creates a new EHC_E04 Group with custom ModelClassFactory.
	 */
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating EHC_E04 - this is probably a bug in the source code generator.", e);
	   }
	}
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public EHC_E04_PRODUCT_SERVICE_SECTION getPRODUCT_SERVICE_SECTION(int rep) throws HL7Exception { 
	   return (EHC_E04_PRODUCT_SERVICE_SECTION)this.get("PRODUCT_SERVICE_SECTION", rep);
	}
	...
	/**
	 * Inserts a specific repetition of EHC_E04_PRODUCT_SERVICE_SECTION
	 * (a Group object)
	 * @see AbstractGroup#insertRepetition(Structure, int) 
	 */
	...
	/**
	 * Removes a specific repetition of EHC_E04_PRODUCT_SERVICE_SECTION
	 * (a Group object)
	 * @see AbstractGroup#insertremoveRepetition(String, int) 
	 */
