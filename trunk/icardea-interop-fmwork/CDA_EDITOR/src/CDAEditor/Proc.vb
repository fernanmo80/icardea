    ...
    Public Sub New(ByVal dr As DataRow)
        ...
        If Not IsNothing(dr) Then
            Try
                ...
                End Try
            Catch ex As Exception
                MessageBox.Show("THE PROCEDURE CODE WAS NOT FOUND...YOU HAVE TO SELECT THE PROCEDURE FROM THE LIST!!!", "PROCEDURE CODE MISSING", MessageBoxButtons.OK, MessageBoxIcon.Warning, MessageBoxDefaultButton.Button1)
