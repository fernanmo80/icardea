    ...
    Public Sub New(ByVal dr As DataRow)
        ...
        If Not IsNothing(dr) Then
            Try
                ...
                End Try
            Catch ex As Exception
                MessageBox.Show("THE VITAL SIGN CODE WAS NOT FOUND...YOU HAVE TO SELECT THE VITAL SIGN FROM THE LIST!!!", "VITAL SIGN CODE MISSING", MessageBoxButtons.OK, MessageBoxIcon.Warning, MessageBoxDefaultButton.Button1)
