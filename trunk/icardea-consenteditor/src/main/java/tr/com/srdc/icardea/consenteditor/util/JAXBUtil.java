...
public class JAXBUtil {
	...
	public static Logger logger = Logger.getLogger(JAXBUtil.class);
	...
	public static void string2File(String content, String directory,
		...
		try {
			...
			try {
				...
				logger.info("Could not write to external file.");
				//e.printStackTrace();
			}
		} catch (IOException e) {
			e.printStackTrace();
	...
	public static void marshall(Object object, String fileDirectory,
		...
		try {
			...
			marshaller.marshal(object, new FileOutputStream(backupFile));
			}
			catch(Exception e){
				logger.info("Could not write to external file.");
				//e.printStackTrace();
