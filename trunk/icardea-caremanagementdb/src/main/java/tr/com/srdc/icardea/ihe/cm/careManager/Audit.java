...
//        }
	...
	public static String createMessage(String messageType, String patientID, String code){
		String xml = "";
		String date = ISO8601Local.format (new Date());
		if(messageType == "PCC-09"){		
			xml = 
				"<AuditMessage>"+
					"<EventIdentification EventActionCode="+"\"R\""+" EventDateTime="+"\""+date+"\""+" EventOutcomeIndicator="+"\"0\""+">"+
					"<EventID code="+"\""+code+"\""+"/>"+
						"<EventTypeCode code="+"\"PCC-09\""+" codeSystemName="+"\"IHE Transactions\""+"/>"+
					"</EventIdentification>"+
		...
		else if(messageType == "PCD-09"){
			xml = 
				"<AuditMessage>"+
					"<EventIdentification EventActionCode="+"\"C\""+" EventDateTime="+"\""+date+"\""+" EventOutcomeIndicator="+"\"0\""+">"+
						"<EventID code="+"\"CIED\""+" displayName="+"\"Cardiac Implantable Electronic Device\""+"/>"+
						"<EventTypeCode code="+"\"PCD-09\""+" codeSystemName="+"\"IHE Transactions\""+"/>"+
					"</EventIdentification>"+
