...
public class SENSINGSETDetachedCriteria extends AbstractORMDetachedCriteria {
	...
	public SENSINGSETDetachedCriteria() {
		super(tr.com.srdc.icardea.hibernate.SENSINGSET.class, tr.com.srdc.icardea.hibernate.SENSINGSETCriteria.class);
		ID = new IntegerExpression("ID", this.getDetachedCriteria());
		sensitivity = new StringExpression("sensitivity", this.getDetachedCriteria());
		...
		adaptation_mode = new StringExpression("adaptation_mode", this.getDetachedCriteria());
		polarity = new StringExpression("polarity", this.getDetachedCriteria());
	}
	
	public SENSINGSETDetachedCriteria(DetachedCriteria aDetachedCriteria) {
		super(aDetachedCriteria, tr.com.srdc.icardea.hibernate.SENSINGSETCriteria.class);
		ID = new IntegerExpression("ID", this.getDetachedCriteria());
		sensitivity = new StringExpression("sensitivity", this.getDetachedCriteria());
		anode_location_1 = new StringExpression("anode_location_1", this.getDetachedCriteria());
		anode_location_2 = new StringExpression("anode_location_2", this.getDetachedCriteria());
	...
	public SENSINGSET uniqueSENSINGSET(PersistentSession session) {
		return (SENSINGSET) super.createExecutableCriteria(session).uniqueResult();
	}
	
	public SENSINGSET[] listSENSINGSET(PersistentSession session) {
