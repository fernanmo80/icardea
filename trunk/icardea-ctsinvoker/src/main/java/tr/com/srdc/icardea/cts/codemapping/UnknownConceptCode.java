...
public class UnknownConceptCode extends java.lang.Exception{
    ...
    private org.hl7.ctsvapi.UnknownConceptCode faultMessage;
    ...
    public void setFaultMessage(org.hl7.ctsvapi.UnknownConceptCode msg){
       faultMessage = msg;
    }
    
    public org.hl7.ctsvapi.UnknownConceptCode getFaultMessage(){
       return faultMessage;
    }
}
