...
public class UnknownCodeSystem extends java.lang.Exception{
    ...
    private org.hl7.ctsmapi.UnknownCodeSystem faultMessage;
    ...
    public void setFaultMessage(org.hl7.ctsmapi.UnknownCodeSystem msg){
       faultMessage = msg;
    }
    
    public org.hl7.ctsmapi.UnknownCodeSystem getFaultMessage(){
       return faultMessage;
    }
}
