 ...
 *       &lt;sequence>
 *         &lt;element name="item" type="{urn://hl7.org/CTSMAPI}ValidationDetail" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ArrayOfValidationDetail {
    ...
    protected List<ValidationDetail> item;
     ...
     * 
     */
    public List<ValidationDetail> getItem() {
        if (item == null) {
            item = new ArrayList<ValidationDetail>();
        }
        return this.item;
    }
